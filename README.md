...
## Папка data 
xsd схемы и схематронов для СЭМД, поддерживаемых 1С:Медицина. Содержимое папки можно использовать для наполнения папки, указанной в переменной DATA_PATH файла prefs.py.
