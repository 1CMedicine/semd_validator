...
- json с объектом из 2-х атрибутов, задающие название полей справочника, являющихся кодом и наименованием (альтернативные, которые используются при кодировании СЭМД).
...
В папке data должна быть создана папка fnsi с такими же правами доступа как к папке data.
