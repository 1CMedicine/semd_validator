...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        ...
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code[@code='5013']]/value">
            <assert test="matches(.,'^[0-9]{2}$')">Согласно НПА для электронного медицинского документа количество знаков в серии должно состоять из двух разрядов.</assert>
    ...
    <pattern>
        ...
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code[@code='12135']]/value">
            ...
            <assert test="@value='true'">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code[@code='12135']]/value должен иметь пустое значение атрибута @value равное 'true'.</assert>
