<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        <rule context="ClinicalDocument/templateId">
            <report test="@nullFlavor">(Требование: У1-3) Элемент ClinicalDocument/templateId не
                должен иметь атрибут @nullFlavor</report>
            <assert test="@root = '1.2.643.5.1.13.13.14.368.9.1'">(Требование: У1-3) Элемент
                templateId обязан содержать один атрибут @root со значением
                "1.2.643.5.1.13.13.14.368.9.1"</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/code">
            <report test="@nullFlavor">(Требование: У1-5) Элемент ClinicalDocument/code не должен
                иметь атрибут @nullFlavor</report>
            <assert test="@code = '368'">(Требование: У1-5) Элемент code обязан содержать один
                атрибут @code со значением "368"</assert>
            <assert
    ...
    <pattern>
        <rule context="ClinicalDocument/recordTarget/patientRole/patient/guardian">
            ...
            <assert test="count(guardianOrganization) = [0, 1]">(Требование: У1-12.1.7.4.8) Элемент
                ...
                (ClinicalDocument/recordTarget/patientRole/patient/guardian) </assert>
            <report test="count(guardianPerson[not(@nullFlavor)]) = 1 and count(guardianOrganization[not(@nullFlavor)]) = 1">(Требование: У1-12.1.7.4.7, У1-12.1.7.4.8) Элементы guardianPerson и guardianOrganization не могут быть представлены совместно (ClinicalDocument/recordTarget/patientRole/patient/guardian)</report>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/id[@root = '1.2.643.100.3'][not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/identity:IdentityDoc[not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/identity:AuthorityDoc[not(@nullFlavor)]">
    ...
    <pattern>
        <rule context="ClinicalDocument/recordTarget/patientRole/patient/guardian/code[not(@nullFlavor)]">
            <assert
    ...
    <pattern>
        <rule context="ClinicalDocument/recordTarget/patientRole/patient/guardian/addr[not(@nullFlavor)]">
    ...
    <pattern>
        <rule context="ClinicalDocument/recordTarget/patientRole/patient/guardian/telecom[not(@nullFlavor)]">
    ...
    <pattern>
        <rule context="ClinicalDocument/recordTarget/patientRole/patient/guardian/guardianPerson[not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/guardianPerson/name/identity:Patronymic[not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/guardianOrganization[not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/guardianOrganization/id[not(@root = '1.2.643.100.3')][not(@root = '1.2.643.5.1.13.2.1.1.1504.101')][not(@root = '1.2.643.5.1.13.13.17.1.1')][not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/guardianOrganization/identity:Props/identity:Ogrn[not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/guardianOrganization/identity:Props/identity:Ogrnip[not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/guardianOrganization/identity:Props/identity:Okpo[not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/guardianOrganization/identity:Props/identity:Okato[not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/patient/guardian/guardianOrganization/addr[not(@nullFlavor)]">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/recordTarget/patientRole/providerOrganization/id[@root = '1.2.643.5.1.13.2.1.1.1504.101'][not(@nullFlavor)]">
    ...
    <pattern>
        <rule context="ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity">
            ...
            <assert test="count(code) = 1">(Требование: У1-19.1.6.2.3) Элемент assignedEntity ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity) </assert>
            <assert test="count(addr) = [0, 1]">(Требование: У1-19.1.6.2.4) Элемент assignedEntity
                МОЖЕТ содержать не более одного [0..1] элемента addr
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity) </assert>
            <assert test="count(telecom) >= 0">(Требование: У1-19.1.6.2.5) Элемент assignedEntity
                МОЖЕТ содержать произвольное количество [0..*] элементов telecom
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity) </assert>
            <assert test="count(assignedPerson) = 1">(Требование: У1-19.1.6.2.6) Элемент
                assignedEntity ОБЯЗАН содержать один [1..1] элемент assignedPerson
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity) </assert>
            <assert test="count(representedOrganization) = [0, 1]">(Требование: У1-19.1.6.2.7)
    ...
    <pattern>
        <rule context="ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/addr[not(@nullFlavor)]">
            <assert test="count(@use != '') = [0, 1]">(Требование: У1-19.1.6.2.4) Элемент addr
                должен содержать один атрибут @use с не пустым значением</assert>
            <assert
                test="
                    if (@use) then
                        ...
                        (not(@use))"
                >(Требование: У1-19.1.6.2.4) Элемент addr должен содержать один атрибут @use с не
                пустым значением</assert>
            <assert test="count(streetAddressLine) = 1">(Требование: У1-19.1.6.2.4.1) Элемент addr
                ОБЯЗАН содержать один [1..1] элемент streetAddressLine
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/addr) </assert>
            <assert test="count(address:stateCode) = 1">(Требование: У1-19.1.6.2.4.2) Элемент addr
                ОБЯЗАН содержать один [1..1] элемент address:stateCode
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/addr) </assert>
            <assert test="count(postalCode) = 1">(Требование: У1-19.1.6.2.4.3) Элемент addr ДОЛЖЕН
                содержать один [1..1] элемент postalCode
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/addr) </assert>
            <assert test="count(fias:Address) = 1">(Требование: У1-19.1.6.2.4.4) Элемент addr ДОЛЖЕН
                содержать один [1..1] элемент fias:Address
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.4.1) Элемент
                ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/addr/streetAddressLine
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У1-19.1.6.2.4.1) Элемент streetAddressLine должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.4.2) Элемент
                ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/addr/address:stateCode
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@codeSystem = ['1.2.643.5.1.13.13.99.2.206', '1.2.643.5.1.13.13.11.1093']"
                >(Требование: У1-19.1.6.2.4.2) Элемент address:stateCode обязан содержать один
                атрибут @codeSystem со значением "1.2.643.5.1.13.13.99.2.206"</assert>
            <assert test="@codeSystemName != ''">(Требование: У1-19.1.6.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @codeSystemName с не пустым
                значением</assert>
            <assert test="@code != ''">(Требование: У1-19.1.6.2.4.2) Элемент address:stateCode
                обязан содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У1-19.1.6.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @codeSystemVersion с не пустым
                значением</assert>
            <assert test="@displayName != ''">(Требование: У1-19.1.6.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @displayName с не пустым
                значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test=". != ''">(Требование: У1-19.1.6.2.4.3) Элемент postalCode должен содержать
                не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test="count(fias:AOGUID) = 1">(Требование: У1-19.1.6.2.4.4.1) Элемент
                fias:Address ОБЯЗАН содержать один [1..1] элемент fias:AOGUID
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/addr/fias:Address) </assert>
            <assert test="count(fias:HOUSEGUID) = 1">(Требование: У1-19.1.6.2.4.4.2) Элемент
                fias:Address ДОЛЖЕН содержать один [1..1] элемент fias:HOUSEGUID
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.4.4.1) Элемент
                ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/addr/fias:Address/fias:AOGUID
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У1-19.1.6.2.4.4.1) Элемент fias:AOGUID должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test=". != ''">(Требование: У1-19.1.6.2.4.4.2) Элемент fias:HOUSEGUID должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test="count(@use != '') = [0, 1]">(Требование: У1-19.1.6.2.5) Элемент telecom
                должен содержать один атрибут @use с не пустым значением</assert>
            <assert
                test="
                    if (@use) then
                        ...
                        (not(@use))"
                >(Требование: У1-19.1.6.2.5) Элемент telecom должен содержать один атрибут @use с не
                пустым значением</assert>
            <assert test="@value != ''">(Требование: У1-19.1.6.2.5) Элемент telecom обязан содержать
                один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.6) Элемент
                ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/assignedPerson
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(name) = 1">(Требование: У1-19.1.6.2.6.1) Элемент assignedPerson
                ОБЯЗАН содержать один [1..1] элемент name
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/assignedPerson)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.6.1) Элемент
                ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/assignedPerson/name
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(family) = 1">(Требование: У1-19.1.6.2.6.1.1) Элемент name ОБЯЗАН
                содержать один [1..1] элемент family
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/assignedPerson/name) </assert>
            <assert test="count(given) = 1">(Требование: У1-19.1.6.2.6.1.2) Элемент name ОБЯЗАН
                содержать один [1..1] элемент given
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/assignedPerson/name) </assert>
            <assert test="count(identity:Patronymic) = [0, 1]">(Требование: У1-19.1.6.2.6.1.3)
                Элемент name МОЖЕТ содержать не более одного [0..1] элемента identity:Patronymic
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/assignedPerson/name)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.6.1.1) Элемент
                ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/assignedPerson/name/family
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У1-19.1.6.2.6.1.1) Элемент family должен содержать
                не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.6.1.2) Элемент
                ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/assignedPerson/name/given
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У1-19.1.6.2.6.1.2) Элемент given должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test=". != ''">(Требование: У1-19.1.6.2.6.1.3) Элемент identity:Patronymic
                должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test="@classCode = 'ORG'">(Требование: У1-19.1.6.2.7) Элемент
                representedOrganization обязан содержать один атрибут @classCode со значением
                "ORG"</assert>
            <assert
                test="count(id[not(@root = '1.2.643.100.3')][not(@root = '1.2.643.5.1.13.2.1.1.1504.101')][not(@root = '1.2.643.5.1.13.13.17.1.1')]) = 1"
                >(Требование: У1-19.1.6.2.7.1) Элемент representedOrganization ОБЯЗАН содержать один
                [1..1] элемент id
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(name) = 1">(Требование: У1-19.1.6.2.7.2) Элемент
                representedOrganization ОБЯЗАН содержать один [1..1] элемент name
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(telecom) >= 0">(Требование: У1-19.1.6.2.7.3) Элемент
                representedOrganization МОЖЕТ содержать произвольное количество [0..*] элементов
                telecom
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(addr) = [0, 1]">(Требование: У1-19.1.6.2.7.4) Элемент
                representedOrganization МОЖЕТ содержать не более одного [0..1] элемента addr
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.7.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@root != ''">(Требование: У1-19.1.6.2.7.1) Элемент id обязан содержать
                один атрибут @root с не пустым значением</assert>
            <assert test="count(@extension != '') = [0, 1]">(Требование: У1-19.1.6.2.7.1) Элемент id
                должен содержать один атрибут @extension с не пустым значением</assert>
            <assert
                test="
                    if (@extension) then
                        ...
                        (not(@extension))"
                >(Требование: У1-19.1.6.2.7.1) Элемент id должен содержать один атрибут @extension с
                не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.7.2) Элемент
                ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/representedOrganization/name
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У1-19.1.6.2.7.2) Элемент name должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test="count(@use != '') = [0, 1]">(Требование: У1-19.1.6.2.7.3) Элемент telecom
                должен содержать один атрибут @use с не пустым значением</assert>
            <assert
                test="
                    if (@use) then
                        ...
                        (not(@use))"
                >(Требование: У1-19.1.6.2.7.3) Элемент telecom должен содержать один атрибут @use с
                не пустым значением</assert>
            <assert test="@value != ''">(Требование: У1-19.1.6.2.7.3) Элемент telecom обязан
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test="count(@use != '') = [0, 1]">(Требование: У1-19.1.6.2.7.4) Элемент addr
                должен содержать один атрибут @use с не пустым значением</assert>
            <assert
                test="
                    if (@use) then
                        ...
                        (not(@use))"
                >(Требование: У1-19.1.6.2.7.4) Элемент addr должен содержать один атрибут @use с не
                пустым значением</assert>
            <assert test="count(streetAddressLine) = 1">(Требование: У1-19.1.6.2.7.4.1) Элемент addr
                ОБЯЗАН содержать один [1..1] элемент streetAddressLine
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(address:stateCode) = 1">(Требование: У1-19.1.6.2.7.4.2) Элемент addr
                ОБЯЗАН содержать один [1..1] элемент address:stateCode
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(postalCode) = 1">(Требование: У1-19.1.6.2.7.4.3) Элемент addr ДОЛЖЕН
                содержать один [1..1] элемент postalCode
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(fias:Address) = 1">(Требование: У1-19.1.6.2.7.4.4) Элемент addr
                ДОЛЖЕН содержать один [1..1] элемент fias:Address
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.7.4.1) Элемент
                ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/representedOrganization/addr/streetAddressLine
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У1-19.1.6.2.7.4.1) Элемент streetAddressLine должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.7.4.2) Элемент
                ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/representedOrganization/addr/address:stateCode
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@codeSystem = ['1.2.643.5.1.13.13.99.2.206', '1.2.643.5.1.13.13.11.1093']"
                >(Требование: У1-19.1.6.2.7.4.2) Элемент address:stateCode обязан содержать один
                атрибут @codeSystem со значением "1.2.643.5.1.13.13.99.2.206"</assert>
            <assert test="@codeSystemName != ''">(Требование: У1-19.1.6.2.7.4.2) Элемент
                address:stateCode обязан содержать один атрибут @codeSystemName с не пустым
                значением</assert>
            <assert test="@code != ''">(Требование: У1-19.1.6.2.7.4.2) Элемент address:stateCode
                обязан содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У1-19.1.6.2.7.4.2) Элемент
                address:stateCode обязан содержать один атрибут @codeSystemVersion с не пустым
                значением</assert>
            <assert test="@displayName != ''">(Требование: У1-19.1.6.2.7.4.2) Элемент
                address:stateCode обязан содержать один атрибут @displayName с не пустым
                значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test=". != ''">(Требование: У1-19.1.6.2.7.4.3) Элемент postalCode должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test="count(fias:AOGUID) = 1">(Требование: У1-19.1.6.2.7.4.4.1) Элемент
                fias:Address ОБЯЗАН содержать один [1..1] элемент fias:AOGUID
                (ClinicalDocument/documentationOf/serviceEvent/performer/assignedEntity/representedOrganization/addr/fias:Address) </assert>
            <assert test="count(fias:HOUSEGUID) = 1">(Требование: У1-19.1.6.2.7.4.4.2) Элемент
                fias:Address ДОЛЖЕН содержать один [1..1] элемент fias:HOUSEGUID
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.6.2.7.4.4.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У1-19.1.6.2.7.4.4.1) Элемент fias:AOGUID должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test=". != ''">(Требование: У1-19.1.6.2.7.4.4.2) Элемент fias:HOUSEGUID должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/componentOf/encompassingEncounter">
            ...
            <assert test="count(id) = [1,2]"
                >(Требование: У1-20.1) Элемент encompassingEncounter ОБЯЗАН содержать не более двух 
                элементов id(ClinicalDocument/componentOf/encompassingEncounter) </assert>
            <assert
    ...
    <pattern>
        <rule context="ClinicalDocument/componentOf/encompassingEncounter[id[substring(@root, string-length(@root) - 2) = '.15']]/id[@root][substring(@root, string-length(@root) - 2) != '.15']">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/componentOf/encompassingEncounter/id[not(@nullFlavor)][substring(@root, string-length(@root) - 2) = ['.16', '.17']]">
    ...
    <pattern>
        <rule
            ...
            <assert test="count(text) = 1">(Требование: У2-1.1.3) Элемент section ОБЯЗАН содержать
                ...
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert
                test="count(entry[substanceAdministration/code/@codeSystem = '1.2.643.5.1.13.13.99.2.848']) = [0, 1]"
                >(Требование: У3-1) Элемент section МОЖЕТ содержать не более одного [0..1] элемента
                entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '8014']) >= 1">(Требование: У3-2)
                Элемент section ОБЯЗАН содержать не менее одного [1..*] элемента entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '837']) = 1">(Требование: У3-3)
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(substanceAdministration) = 1">(Требование: У3-1.1) Элемент entry
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'SBADM'">(Требование: У3-1.1) Элемент substanceAdministration
                обязан содержать один атрибут @classCode со значением "SBADM"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-1.1) Элемент substanceAdministration
                обязан содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-1.1.1) Элемент substanceAdministration
            ...
            <assert test="count(effectiveTime) = 1">(Требование: У3-1.1.2) Элемент
                substanceAdministration ОБЯЗАН содержать один [1..1] элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[substanceAdministration/code/@codeSystem='1.2.643.5.1.13.13.99.2.848']/substanceAdministration) </assert>
            <assert test="count(consumable) = 1">(Требование: У3-1.1.3) Элемент
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-1.1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.848'">(Требование: У3-1.1.1) Элемент
                code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.848"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-1.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-1.1.1) Элемент code обязан содержать один
                атрибут @code с не пустым значением</assert>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-1.1.2) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@value != ''">(Требование: У3-1.1.2) Элемент effectiveTime обязан
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-1.1.3) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'CSM'">(Требование: У3-1.1.3) Элемент consumable обязан
                содержать один атрибут @typeCode со значением "CSM"</assert>
            <assert test="count(manufacturedProduct) = 1">(Требование: У3-1.1.3.1) Элемент
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-1.1.3.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'MANU'">(Требование: У3-1.1.3.1) Элемент manufacturedProduct
                обязан содержать один атрибут @classCode со значением "MANU"</assert>
            <assert test="count(manufacturedMaterial) = 1">(Требование: У3-1.1.3.1.1) Элемент
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-1.1.3.1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'MMAT'">(Требование: У3-1.1.3.1.1) Элемент
                manufacturedMaterial обязан содержать один атрибут @classCode со значением
                "MMAT"</assert>
            <assert test="@determinerCode = 'KIND'">(Требование: У3-1.1.3.1.1) Элемент
                manufacturedMaterial обязан содержать один атрибут @determinerCode со значением
                "KIND"</assert>
            <assert test="count(code) = 1">(Требование: У3-1.1.3.1.1.1) Элемент manufacturedMaterial
                ОБЯЗАН содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[substanceAdministration/code/@codeSystem='1.2.643.5.1.13.13.99.2.848']/substanceAdministration/consumable/manufacturedProduct/manufacturedMaterial)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-1.1.3.1.1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.11.1078'">(Требование: У3-1.1.3.1.1.1)
                Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.11.1078"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-1.1.3.1.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-1.1.3.1.1.1) Элемент code обязан содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-1.1.3.1.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-1.1.3.1.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '8014']">
            <report test="@nullFlavor">(Требование: У3-2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='8014']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '8014']/observation">
            <report test="@nullFlavor">(Требование: У3-2.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='8014']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-2.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='8014']/observation) </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '8014']/observation/code">
            <report test="@nullFlavor">(Требование: У3-2.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='8014']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '8014'">(Требование: У3-2.1.1) Элемент code обязан содержать один
                атрибут @code со значением "8014"</assert>
            <assert
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '8014']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-2.1.2) Элемент value обязан содержать
                один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.960'">(Требование: У3-2.1.2) Элемент
                value должен содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.823"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-2.1.2) Элемент value должен
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-2.1.2) Элемент value должен содержать один
                атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-2.1.2) Элемент value должен
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-2.1.2) Элемент value должен содержать
                один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '8014']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-2.1.2) Элемент value обязан содержать
                один атрибут @xsi:type со значением "CD"</assert>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-3.1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '837'">(Требование: У3-3.1.1) Элемент code обязан содержать один
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-3.1.2) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'CD'">(Требование: У3-3.1.2) Элемент value обязан содержать
                один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@code = '44'">(Требование: У3-3.1.2) Элемент value обязан содержать один
                атрибут @code со значением "44"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.725'">(Требование: У3-3.1.2) Элемент
                value обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.725"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-3.1.2) Элемент value обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-3.1.2) Элемент value обязан содержать
                один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-3.1.2) Элемент value обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule
            ...
            <assert test="count(text) = 1">(Требование: У2-2.1.3) Элемент section ОБЯЗАН содержать
                один [1..1] элемент text
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section) </assert>
            <assert test="count(entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']) >= 1"
                >(Требование: У3-5) Элемент section ОБЯЗАН содержать не менее одного [1..*] элемента
                entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У2-2.1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = 'LINKDOCS'">(Требование: У2-2.1.1) Элемент code обязан содержать
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']">
            <report test="@nullFlavor">(Требование: У3-5) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']) = 1"
                >(Требование: У3-5.1) Элемент entry ОБЯЗАН содержать один [1..1] элемент act
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522'])
            </assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']">
            <report test="@nullFlavor">(Требование: У3-5.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'ACT'">(Требование: У3-5.1) Элемент act обязан содержать один
                атрибут @classCode со значением "ACT"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-5.1) Элемент act обязан содержать один
                атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-5.1.1) Элемент act ОБЯЗАН содержать один
                [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']) </assert>
            <assert test="count(text) = [0, 1]">(Требование: У3-5.1.2) Элемент act МОЖЕТ содержать
                не более одного [0..1] элемента text
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']) </assert>
            <assert test="count(effectiveTime) = 1">(Требование: У3-5.1.3) Элемент act ОБЯЗАН
                содержать один [1..1] элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '11002']) = [0, 1]"
                >(Требование: У3-5.1.4) Элемент act МОЖЕТ содержать не более одного [0..1] элемента
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '11003']) = [0, 1]"
                >(Требование: У3-5.1.5) Элемент act МОЖЕТ содержать не более одного [0..1] элемента
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '4171']) = [0, 1]"
                >(Требование: У3-5.1.6) Элемент act МОЖЕТ содержать не более одного [0..1] элемента
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '6058']) = [0, 1]"
                >(Требование: У3-5.1.7) Элемент act МОЖЕТ содержать не более одного [0..1] элемента
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']) </assert>
            <assert test="count(reference) = 1">(Требование: У3-5.1.8) Элемент act ОБЯЗАН содержать
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/code">
            <report test="@nullFlavor">(Требование: У3-5.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/code
                не должен иметь атрибут @nullFlavor</report>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.11.1522', '1.2.643.5.1.13.2.1.1.646', '1.2.643.5.1.13.13.11.1115', '1.2.643.5.1.13.13.99.2.195']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/text[not(@nullFlavor)]">
            <report test="@nullFlavor">(Требование: У3-5.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/text
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-5.1.2) Элемент text должен содержать не пустое
                текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/effectiveTime">
            <report test="@nullFlavor">(Требование: У3-5.1.3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/effectiveTime
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@value != ''">(Требование: У3-5.1.3) Элемент effectiveTime обязан
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '11002']">
            <report test="@nullFlavor">(Требование: У3-5.1.4) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11002']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-5.1.4) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-5.1.4.1) Элемент entryRelationship
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '11002']/observation">
            <report test="@nullFlavor">(Требование: У3-5.1.4.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11002']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-5.1.4.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-5.1.4.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-5.1.4.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11002']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-5.1.4.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11002']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '11002']/observation/code">
            <report test="@nullFlavor">(Требование: У3-5.1.4.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11002']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11002'">(Требование: У3-5.1.4.1.1) Элемент code обязан содержать
                один атрибут @code со значением "11002"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-5.1.4.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-5.1.4.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-5.1.4.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-5.1.4.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '11002']/observation/value">
            <report test="@nullFlavor">(Требование: У3-5.1.4.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11002']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'ST'">(Требование: У3-5.1.4.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "ST"</assert>
            <assert test=". != ''">(Требование: У3-5.1.4.1.2) Элемент value должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '11003']">
            <report test="@nullFlavor">(Требование: У3-5.1.5) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11003']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '11003']/observation">
            <report test="@nullFlavor">(Требование: У3-5.1.5.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11003']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-5.1.5.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11003']/observation) </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '11003']/observation/code">
            <report test="@nullFlavor">(Требование: У3-5.1.5.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11003']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11003'">(Требование: У3-5.1.5.1.1) Элемент code обязан содержать
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '11003']/observation/value">
            <report test="@nullFlavor">(Требование: У3-5.1.5.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='11003']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'ST'">(Требование: У3-5.1.5.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "ST"</assert>
            <assert test=". != ''">(Требование: У3-5.1.5.1.2) Элемент value должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '4171']">
            <report test="@nullFlavor">(Требование: У3-5.1.6) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='4171']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-5.1.6) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-5.1.6.1) Элемент entryRelationship
                ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='4171'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '4171']/observation">
            <report test="@nullFlavor">(Требование: У3-5.1.6.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='4171']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-5.1.6.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-5.1.6.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-5.1.6.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='4171']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-5.1.6.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='4171']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '4171']/observation/code">
            <report test="@nullFlavor">(Требование: У3-5.1.6.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='4171']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '4171'">(Требование: У3-5.1.6.1.1) Элемент code обязан содержать
                один атрибут @code со значением "4171"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-5.1.6.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-5.1.6.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-5.1.6.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-5.1.6.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '4171']/observation/value">
            <report test="@nullFlavor">(Требование: У3-5.1.6.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='4171']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'ST'">(Требование: У3-5.1.6.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "ST"</assert>
            <assert test=". != ''">(Требование: У3-5.1.6.1.2) Элемент value должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '6058']">
            <report test="@nullFlavor">(Требование: У3-5.1.7) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='6058']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-5.1.7) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-5.1.7.1) Элемент entryRelationship
                ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='6058'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '6058']/observation">
            <report test="@nullFlavor">(Требование: У3-5.1.7.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='6058']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-5.1.7.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-5.1.7.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-5.1.7.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='6058']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-5.1.7.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='6058']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '6058']/observation/code">
            <report test="@nullFlavor">(Требование: У3-5.1.7.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='6058']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '6058'">(Требование: У3-5.1.7.1.1) Элемент code обязан содержать
                один атрибут @code со значением "6058"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-5.1.7.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-5.1.7.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-5.1.7.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-5.1.7.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code = '6058']/observation/value">
            <report test="@nullFlavor">(Требование: У3-5.1.7.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/entryRelationship[observation/code/@code='6058']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'CD'">(Требование: У3-5.1.7.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.1008'">(Требование: У3-5.1.7.1.2)
                Элемент value обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.1008"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-5.1.7.1.2) Элемент value обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-5.1.7.1.2) Элемент value обязан содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-5.1.7.1.2) Элемент value обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-5.1.7.1.2) Элемент value обязан
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/reference">
            <report test="@nullFlavor">(Требование: У3-5.1.8) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/reference
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'REFR'">(Требование: У3-5.1.8) Элемент reference обязан
                содержать один атрибут @typeCode со значением "REFR"</assert>
            <assert test="count(externalDocument) = 1">(Требование: У3-5.1.8.1) Элемент reference
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/reference/externalDocument">
            <report test="@nullFlavor">(Требование: У3-5.1.8.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/reference/externalDocument
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'DOCCLIN'">(Требование: У3-5.1.8.1) Элемент externalDocument
                обязан содержать один атрибут @classCode со значением "DOCCLIN"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-5.1.8.1) Элемент externalDocument
                обязан содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(id[1]) = 1">(Требование: У3-5.1.8.1.1) Элемент externalDocument
                ДОЛЖЕН содержать один [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/reference/externalDocument) </assert>
            <assert test="count(id[2]) = 1">(Требование: У3-5.1.8.1.2) Элемент externalDocument
                ДОЛЖЕН содержать один [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem='1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem='1.2.643.5.1.13.13.11.1522']/reference/externalDocument)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/reference/externalDocument/id[1][not(@nullFlavor)]">
            <assert test="@root != ''">(Требование: У3-5.1.8.1.1) Элемент id должен содержать один
                атрибут @root с не пустым значением</assert>
            <assert test="@extension != ''">(Требование: У3-5.1.8.1.1) Элемент id должен содержать
                один атрибут @extension с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/reference/externalDocument/id[1][@nullFlavor]">
            <report test="@root">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @root</report>
            <report test="@extension">Атрибут nullFlavor не должен быть представлен совместно с
                атрибутом @extension</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/reference/externalDocument/id[2][not(@nullFlavor)]">
            <assert test="@root = '1.2.643.5.1.13.13.17.1.1'">(Требование: У3-5.1.8.1.2) Элемент id
                должен содержать один атрибут @root со значением "1.2.643.5.1.13.13.17.1.1"</assert>
            <assert test="@extension != ''">(Требование: У3-5.1.8.1.2) Элемент id должен содержать
                один атрибут @extension с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/act[code/@codeSystem = '1.2.643.5.1.13.13.11.1522']/reference/externalDocument/id[2][@nullFlavor]">
            <report test="@extension">Атрибут nullFlavor не должен быть представлен совместно с
                атрибутом @extension</report>
        </rule>
    </pattern>
    ...
    <pattern>
        <rule context="//identity:Props[not(@nullFlavor)][identity:Ogrnip or identity:Ogrn]">
            <assert
    ...
    <pattern>
        <rule
            ...
            <assert test="identity:DocInfo/@nullFlavor = ['INV', 'NAV']">Main07-1. Элемент
                ClinicalDocument/participant/associatedEntity/identity:DocInfo должен иметь значение
                атрибута @nullFlavor равное 'INV' или 'NAV'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
    ...
    <pattern>
        <rule
            context="ClinicalDocument/participant[@typeCode = 'IND']/associatedEntity[code/@code = ['1', '3', '6']]">
            <assert test="count(scopingOrganization[not(@nullFlavor)])=1">Main07-1. Элемент
                ClinicalDocument/participant/associatedEntity/scopingOrganization должен быть представлен.</assert>
        </rule>
    </pattern>
