<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        <rule context="ClinicalDocument">
            ...
            <assert test="count(participant[@typeCode = 'IND']) = [0, 1]">(Требование: У1-18)
                ...
                (ClinicalDocument) </assert>
            <assert test="count(componentOf) = 1">(Требование: У1-19) Элемент ClinicalDocument
                ОБЯЗАН содержать один [1..1] элемент componentOf (ClinicalDocument) </assert>
            <assert test="count(component) = 1">(Требование: У1-20) Элемент ClinicalDocument ОБЯЗАН
    ...
    <pattern>
        <rule context="ClinicalDocument/templateId">
            <report test="@nullFlavor">(Требование: У1-3) Элемент ClinicalDocument/templateId не
                должен иметь атрибут @nullFlavor</report>
            <assert test="@root = '1.2.643.5.1.13.13.15.95.1'">(Требование: У1-3) Элемент templateId
                обязан содержать один атрибут @root со значением
                "1.2.643.5.1.13.13.15.95.1"</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/code">
            <report test="@nullFlavor">(Требование: У1-5) Элемент ClinicalDocument/code не должен
                иметь атрибут @nullFlavor</report>
            <assert test="@code = '95'">(Требование: У1-5) Элемент code обязан содержать один
                атрибут @code со значением "95"</assert>
    ...
    <pattern>
        <rule context="ClinicalDocument/code/translation">
            ...
            <assert test="@code = '211'">Элемент translation обязан содержать один
                атрибут @code со значением "211"</assert>
    ...
    <pattern>
        <rule context="ClinicalDocument/recordTarget/patientRole/addr[not(@nullFlavor)]">
            ...
            <assert test="count(postalCode) = 1">(Требование: У1-12.1.5.4) Элемент addr ДОЛЖЕН
                ...
                (ClinicalDocument/recordTarget/patientRole/addr) </assert>
            <assert test="count(fias:Address) = 1">(Требование: У1-12.1.5.5) Элемент addr ОБЯЗАН
    ...
    <pattern>
        <rule context="ClinicalDocument/recordTarget/patientRole/addr/fias:Address">
            <report test="@nullFlavor">(Требование: У1-12.1.5.5) Элемент
                ClinicalDocument/recordTarget/patientRole/addr/fias:Address не должен иметь атрибут
                @nullFlavor</report>
    ...
    <pattern>
        <rule context="ClinicalDocument/recordTarget/patientRole/providerOrganization">
            ...
            <assert test="count(addr) = 1">(Требование: У1-12.1.8.6) Элемент providerOrganization
    ...
    <pattern>
        <rule context="ClinicalDocument/componentOf">
            <report test="@nullFlavor">(Требование: У1-19) Элемент ClinicalDocument/componentOf не
                должен иметь атрибут @nullFlavor</report>
            <assert test="count(encompassingEncounter) = 1">(Требование: У1-19.1) Элемент
    ...
    <pattern>
        <rule context="ClinicalDocument/componentOf/encompassingEncounter">
            ...
            <assert test="count(id[substring(@root, string-length(@root) - 2) = '.15']) = 1"
                >(Требование: У1-19.1.1) Элемент encompassingEncounter ОБЯЗАН содержать один [1..1]
            ...
            <assert
                ...
                >(Требование: У1-19.1.2) Элемент encompassingEncounter ОБЯЗАН содержать один [1..1]
                элемент id (ClinicalDocument/componentOf/encompassingEncounter) </assert>
            <assert test="count(code) = [0, 1]">(Требование: У1-19.1.3) Элемент
            ...
            <assert test="count(medService:DocType) = [0, 1]">(Требование: У1-19.1.4) Элемент
            ...
            <assert test="count(effectiveTime) = [0, 1]">(Требование: У1-19.1.5) Элемент
    ...
    <pattern>
        <rule context="ClinicalDocument/componentOf/encompassingEncounter[code/@code='3']">
            <assert test="count(medService:DocType) = 1">(Требование: У1-19.1.4) Элемент
                encompassingEncounter МОЖЕТ содержать не более одного [0..1] элемента; Если атрибут ClinicalDocument/componentOf/encompassingEncounter/code/@code 
                представлен со значением "3", то элемент обязан быть представлен. Если иначе, то элемент должен отсутствовать.
                medService:DocType (ClinicalDocument/componentOf/encompassingEncounter) </assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/componentOf/encompassingEncounter[code/@code!='3']">
            <report test="count(medService:DocType) = 1">(Требование: У1-19.1.4) Элемент
                encompassingEncounter МОЖЕТ содержать не более одного [0..1] элемента; Если атрибут ClinicalDocument/componentOf/encompassingEncounter/code/@code 
                представлен со значением "3", то элемент обязан быть представлен. Если иначе, то элемент должен отсутствовать.
                medService:DocType (ClinicalDocument/componentOf/encompassingEncounter) </report>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <assert test="@root != ''">(Требование: У1-19.1.1) Элемент id обязан содержать один
                атрибут @root с не пустым значением; допустимый формат значения:
                OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.15</assert>
            <assert test="matches(@root, '^[0-2](\.([1-9][0-9]*|0))+\.15$')">(Требование: У1-19.1.1)
                Элемент id обязан содержать один атрибут @root с не пустым значением; допустимый
                формат значения: OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.15</assert>
            <assert test="@extension != ''">(Требование: У1-19.1.1) Элемент id обязан содержать один
                атрибут @extension с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У1-19.1.2) Элемент
                ...
                @nullFlavor</report>
            <assert test="@root != ''">(Требование: У1-19.1.2) Элемент id обязан содержать один
                атрибут @root с не пустым значением; допустимый формат значения:
            ...
            <assert test="matches(@root, '^[0-2](\.([1-9][0-9]*|0))+\.(16|17)$')">(Требование:
                У1-19.1.2) Элемент id обязан содержать один атрибут @root с не пустым значением;
                допустимый формат значения: OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.16;
                допустимый формат значения:
                OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.17</assert>
            <assert test="@extension != ''">(Требование: У1-19.1.2) Элемент id обязан содержать один
                атрибут @extension с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/componentOf/encompassingEncounter/code">
            <report test="@nullFlavor">(Требование: У1-19.1.3) Элемент
                ...
                @nullFlavor</report>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.723'">(Требование: У1-19.1.3)
                Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.723"</assert>
            <assert test="@codeSystemName != ''">(Требование: У1-19.1.3) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У1-19.1.3) Элемент code обязан содержать один
                атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У1-19.1.3) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У1-19.1.3) Элемент code обязан содержать
                один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/componentOf/encompassingEncounter/medService:DocType">
            ...
            <assert
                ...
                >(Требование: У1-19.1.4) Элемент medService:DocType обязан содержать один атрибут
                @codeSystem со значением "1.2.643.5.1.13.13.11.1522"</assert>
            <assert test="@codeSystemName != ''">(Требование: У1-19.1.4) Элемент medService:DocType
                обязан содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У1-19.1.4) Элемент medService:DocType обязан
                содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У1-19.1.4) Элемент
                ...
                значением</assert>
            <assert test="@displayName != ''">(Требование: У1-19.1.4) Элемент medService:DocType
                обязан содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/componentOf/encompassingEncounter/effectiveTime">
            <report test="@nullFlavor">(Требование: У1-19.1.5) Элемент
                ...
                атрибут @nullFlavor</report>
            <assert test="count(low) = 1">(Требование: У1-19.1.5.1) Элемент effectiveTime ОБЯЗАН
                содержать один [1..1] элемент low
                (ClinicalDocument/componentOf/encompassingEncounter/effectiveTime) </assert>
            <assert test="count(high) = [0, 1]">(Требование: У1-19.1.5.2) Элемент effectiveTime
    ...
    <pattern>
        <rule context="ClinicalDocument/componentOf/encompassingEncounter/effectiveTime/low">
            <report test="@nullFlavor">(Требование: У1-19.1.5.1) Элемент
                ClinicalDocument/componentOf/encompassingEncounter/effectiveTime/low не должен иметь
                атрибут @nullFlavor</report>
            <assert test="@value != ''">(Требование: У1-19.1.5.1) Элемент low обязан содержать один
    ...
    <pattern>
        <rule context="ClinicalDocument/componentOf/encompassingEncounter/effectiveTime/high">
            <report test="@nullFlavor">(Требование: У1-19.1.5.2) Элемент
                ClinicalDocument/componentOf/encompassingEncounter/effectiveTime/high не должен
                иметь атрибут @nullFlavor</report>
            <assert test="@value != ''">(Требование: У1-19.1.5.2) Элемент high обязан содержать один
                атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component">
            <report test="@nullFlavor">(Требование: У1-20) Элемент ClinicalDocument/component не
                должен иметь атрибут @nullFlavor</report>
            <assert test="count(structuredBody) = 1">(Требование: У1-20.1) Элемент component ОБЯЗАН
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            ...
            <assert test="count(component[section/code/@code = 'DGN']) = 1">(Требование: У2-2)
                Элемент structuredBody ОБЯЗАН содержать один [1..1] элемент component
                (ClinicalDocument/component/structuredBody) </assert>
            <assert test="count(component[section/code/@code = 'STAGETREATMENT']) = [0, 1]"
                >(Требование: У2-3) Элемент structuredBody МОЖЕТ содержать не более одного [0..1]
                элемента component (ClinicalDocument/component/structuredBody) </assert>
            <assert test="count(component[section/code/@code = 'ORGINFO']) = [0, 1]">(Требование:
            ...
            <assert test="count(component[section/code/@code = 'LINKDOCS']) = [0, 1]">(Требование:
                У2-5) Элемент structuredBody МОЖЕТ содержать не более одного [0..1] элемента
                component (ClinicalDocument/component/structuredBody) </assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule
            ...
            <assert test="count(title) = 1">(Требование: У2-1.1.2) Элемент section ОБЯЗАН содержать
                ...
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '12408']) = 1">(Требование: У3-1)
                Элемент section ОБЯЗАН содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '12322']) = 1">(Требование: У3-2)
                Элемент section ОБЯЗАН содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '11007']) = [0, 1]">(Требование:
                У3-3) Элемент section МОЖЕТ содержать не более одного [0..1] элемента entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '12456']) = [0, 1]">(Требование:
                У3-4) Элемент section МОЖЕТ содержать не более одного [0..1] элемента entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '12411']) = 1">(Требование: У3-5)
                Элемент section ОБЯЗАН содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '12306']) >= 1">(Требование: У3-6)
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12408']">
            <report test="@nullFlavor">(Требование: У3-1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12408']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12408']/observation">
            <report test="@nullFlavor">(Требование: У3-1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12408']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-1.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12408']/observation) </assert>
            <assert test="count(effectiveTime) = 1">(Требование: У3-1.1.2) Элемент observation
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12408']/observation/code">
            <report test="@nullFlavor">(Требование: У3-1.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12408']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12408'">(Требование: У3-1.1.1) Элемент code обязан содержать один
                атрибут @code со значением "12408"</assert>
            <assert
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12408']/observation/effectiveTime[not(@nullFlavor)]">
            <assert test="@value != ''">(Требование: У3-1.1.2) Элемент effectiveTime должен
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12408']/observation/effectiveTime[@nullFlavor]">
            <report test="@value">Атрибут nullFlavor не должен быть представлен совместно с
                атрибутом @value</report>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12322']">
            <report test="@nullFlavor">(Требование: У3-2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12322']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12322']/observation">
            <report test="@nullFlavor">(Требование: У3-2.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12322']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-2.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12322']/observation) </assert>
            <assert test="count(effectiveTime) = 1">(Требование: У3-2.1.2) Элемент observation
                ДОЛЖЕН содержать один [1..1] элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12322']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12322']/observation/code">
            <report test="@nullFlavor">(Требование: У3-2.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12322']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12322'">(Требование: У3-2.1.1) Элемент code обязан содержать один
                атрибут @code со значением "12322"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12322']/observation/effectiveTime[not(@nullFlavor)]">
            <assert test="@value != ''">(Требование: У3-2.1.2) Элемент effectiveTime должен
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12322']/observation/effectiveTime[@nullFlavor]">
            <report test="@value">Атрибут nullFlavor не должен быть представлен совместно с
                атрибутом @value</report>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation">
            ...
            <assert test="count(code) = 1">(Требование: У3-3.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation) </assert>
            <assert test="count(effectiveTime) = 1">(Требование: У3-3.1.2) Элемент observation
                ОБЯЗАН содержать один [1..1] элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '12016']) = 1"
                >(Требование: У3-3.1.3) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/code">
            <report test="@nullFlavor">(Требование: У3-3.1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11007'">(Требование: У3-3.1.1) Элемент code обязан содержать один
                атрибут @code со значением "11007"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/effectiveTime">
            <report test="@nullFlavor">(Требование: У3-3.1.2) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@value != ''">(Требование: У3-3.1.2) Элемент effectiveTime обязан
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']">
            <report test="@nullFlavor">(Требование: У3-3.1.3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-3.1.3) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-3.1.3.1) Элемент entryRelationship
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-3.1.3.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-3.1.3.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-3.1.3.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation) </assert>
            <assert test="count(performer) = 1">(Требование: У3-3.1.3.1.2) Элемент observation
                ОБЯЗАН содержать один [1..1] элемент performer
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation)
            </assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/code">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12016'">(Требование: У3-3.1.3.1.1) Элемент code обязан содержать
                один атрибут @code со значением "12016"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-3.1.3.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-3.1.3.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-3.1.3.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-3.1.3.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(assignedEntity) = 1">(Требование: У3-3.1.3.1.2.1) Элемент performer
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.2.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(id) = 1">(Требование: У3-3.1.3.1.2.1.1) Элемент assignedEntity
                ДОЛЖЕН содержать один [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity) </assert>
            <assert test="count(representedOrganization) = 1">(Требование: У3-3.1.3.1.2.1.2) Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/id">
            <assert test="@nullFlavor = 'NI'">(Требование: У3-3.1.3.1.2.1.1) Элемент id обязан
                содержать один атрибут @nullFlavor со значением "NI"</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.2.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'ORG'">(Требование: У3-3.1.3.1.2.1.2) Элемент
                representedOrganization обязан содержать один атрибут @classCode со значением
                "ORG"</assert>
            <assert
                test="count(id[not(@root = '1.2.643.100.3')][not(@root = '1.2.643.5.1.13.2.1.1.1504.101')][not(@root = '1.2.643.5.1.13.13.17.1.1')]) = 1"
                >(Требование: У3-3.1.3.1.2.1.2.1) Элемент representedOrganization ОБЯЗАН содержать
                один [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(name) = 1">(Требование: У3-3.1.3.1.2.1.2.2) Элемент
                representedOrganization ОБЯЗАН содержать один [1..1] элемент name
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(telecom) >= 0">(Требование: У3-3.1.3.1.2.1.2.3) Элемент
                representedOrganization МОЖЕТ содержать произвольное количество [0..*] элементов
                telecom
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(addr) = [0, 1]">(Требование: У3-3.1.3.1.2.1.2.4) Элемент
                representedOrganization МОЖЕТ содержать не более одного [0..1] элемента addr
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/id[not(@root = '1.2.643.100.3')][not(@root = '1.2.643.5.1.13.2.1.1.1504.101')][not(@root = '1.2.643.5.1.13.13.17.1.1')]">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.2.1.2.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/id[not(@root='1.2.643.100.3')][not(@root='1.2.643.5.1.13.2.1.1.1504.101')][not(@root='1.2.643.5.1.13.13.17.1.1')]
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@root != ''">(Требование: У3-3.1.3.1.2.1.2.1) Элемент id обязан содержать
                один атрибут @root с не пустым значением</assert>
            <assert test="count(@extension != '') = [0, 1]">(Требование: У3-3.1.3.1.2.1.2.1) Элемент
                id должен содержать один атрибут @extension с не пустым значением</assert>
            <assert
                test="
                    if (@extension) then
                        @extension != ''
                        ...
                        (not(@extension))"
                >(Требование: У3-3.1.3.1.2.1.2.1) Элемент id должен содержать один атрибут
                @extension с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/name">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.2.1.2.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/name
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-3.1.3.1.2.1.2.2) Элемент name должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/telecom">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.2.1.2.3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/telecom
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(@use != '') = [0, 1]">(Требование: У3-3.1.3.1.2.1.2.3) Элемент
            ...
            <assert
                test="
                    if (@use) then
                        ...
                        (not(@use))"
                >(Требование: У3-3.1.3.1.2.1.2.3) Элемент telecom должен содержать один атрибут @use
                с не пустым значением</assert>
            <assert test="@value != ''">(Требование: У3-3.1.3.1.2.1.2.3) Элемент telecom обязан
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.2.1.2.4) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(@use != '') = [0, 1]">(Требование: У3-3.1.3.1.2.1.2.4) Элемент addr
                должен содержать один атрибут @use с не пустым значением</assert>
            <assert
                test="
                    if (@use) then
                        ...
                        (not(@use))"
                >(Требование: У3-3.1.3.1.2.1.2.4) Элемент addr должен содержать один атрибут @use с
                не пустым значением</assert>
            <assert test="count(streetAddressLine) = 1">(Требование: У3-3.1.3.1.2.1.2.4.1) Элемент
                addr ОБЯЗАН содержать один [1..1] элемент streetAddressLine
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(address:stateCode) = 1">(Требование: У3-3.1.3.1.2.1.2.4.2) Элемент
                addr ОБЯЗАН содержать один [1..1] элемент address:stateCode
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(postalCode) = 1">(Требование: У3-3.1.3.1.2.1.2.4.3) Элемент addr
                ДОЛЖЕН содержать один [1..1] элемент postalCode
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(fias:Address) = 1">(Требование: У3-3.1.3.1.2.1.2.4.4) Элемент addr
                ДОЛЖЕН содержать один [1..1] элемент fias:Address
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/streetAddressLine">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.2.1.2.4.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr/streetAddressLine
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-3.1.3.1.2.1.2.4.1) Элемент streetAddressLine
                должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/address:stateCode">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.2.1.2.4.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr/address:stateCode
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@codeSystem = ['1.2.643.5.1.13.13.99.2.206', '1.2.643.5.1.13.13.11.1093']"
                >(Требование: У3-3.1.3.1.2.1.2.4.2) Элемент address:stateCode обязан содержать один
                атрибут @codeSystem со значением "1.2.643.5.1.13.13.99.2.206"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-3.1.3.1.2.1.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @codeSystemName с не пустым
                значением</assert>
            <assert test="@code != ''">(Требование: У3-3.1.3.1.2.1.2.4.2) Элемент address:stateCode
                обязан содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-3.1.3.1.2.1.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @codeSystemVersion с не пустым
                значением</assert>
            <assert test="@displayName != ''">(Требование: У3-3.1.3.1.2.1.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @displayName с не пустым
                значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/postalCode[not(@nullFlavor)]">
            <assert test=". != ''">(Требование: У3-3.1.3.1.2.1.2.4.3) Элемент postalCode должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address[not(@nullFlavor)]">
            <assert test="count(fias:AOGUID) = 1">(Требование: У3-3.1.3.1.2.1.2.4.4.1) Элемент
                fias:Address ОБЯЗАН содержать один [1..1] элемент fias:AOGUID
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address) </assert>
            <assert test="count(fias:HOUSEGUID) = 1">(Требование: У3-3.1.3.1.2.1.2.4.4.2) Элемент
                fias:Address ДОЛЖЕН содержать один [1..1] элемент fias:HOUSEGUID
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address)
            </assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:AOGUID">
            <report test="@nullFlavor">(Требование: У3-3.1.3.1.2.1.2.4.4.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11007']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:AOGUID
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-3.1.3.1.2.1.2.4.4.1) Элемент fias:AOGUID должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11007']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:HOUSEGUID[not(@nullFlavor)]">
            <assert test=". != ''">(Требование: У3-3.1.3.1.2.1.2.4.4.2) Элемент fias:HOUSEGUID
                должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']">
            <report test="@nullFlavor">(Требование: У3-4) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation">
            <report test="@nullFlavor">(Требование: У3-4.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-4.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation) </assert>
            <assert test="count(effectiveTime) = 1">(Требование: У3-4.1.2) Элемент observation
                ОБЯЗАН содержать один [1..1] элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '12016']) = 1"
                >(Требование: У3-4.1.3) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/code">
            <report test="@nullFlavor">(Требование: У3-4.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12456'">(Требование: У3-4.1.1) Элемент code обязан содержать один
                атрибут @code со значением "12456"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/effectiveTime">
            <report test="@nullFlavor">(Требование: У3-4.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/effectiveTime
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@value != ''">(Требование: У3-4.1.2) Элемент effectiveTime обязан
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']">
            <report test="@nullFlavor">(Требование: У3-4.1.3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-4.1.3) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-4.1.3.1) Элемент entryRelationship
                ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-4.1.3.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-4.1.3.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-4.1.3.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation) </assert>
            <assert test="count(performer) = 1">(Требование: У3-4.1.3.1.2) Элемент observation
                ОБЯЗАН содержать один [1..1] элемент performer
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/code">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12016'">(Требование: У3-4.1.3.1.1) Элемент code обязан содержать
                один атрибут @code со значением "12016"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-4.1.3.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-4.1.3.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-4.1.3.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-4.1.3.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(assignedEntity) = 1">(Требование: У3-4.1.3.1.2.1) Элемент performer
                ОБЯЗАН содержать один [1..1] элемент assignedEntity
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.2.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(id) = 1">(Требование: У3-4.1.3.1.2.1.1) Элемент assignedEntity
                ДОЛЖЕН содержать один [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity) </assert>
            <assert test="count(representedOrganization) = 1">(Требование: У3-4.1.3.1.2.1.2) Элемент
                assignedEntity ОБЯЗАН содержать один [1..1] элемент representedOrganization
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/id">
            <assert test="@nullFlavor = 'NI'">(Требование: У3-4.1.3.1.2.1.1) Элемент id обязан
                содержать один атрибут @nullFlavor со значением "NI"</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.2.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'ORG'">(Требование: У3-4.1.3.1.2.1.2) Элемент
                representedOrganization обязан содержать один атрибут @classCode со значением
                "ORG"</assert>
            <assert
                test="count(id[not(@root = '1.2.643.100.3')][not(@root = '1.2.643.5.1.13.2.1.1.1504.101')][not(@root = '1.2.643.5.1.13.13.17.1.1')]) = 1"
                >(Требование: У3-4.1.3.1.2.1.2.1) Элемент representedOrganization ОБЯЗАН содержать
                один [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(name) = 1">(Требование: У3-4.1.3.1.2.1.2.2) Элемент
                representedOrganization ОБЯЗАН содержать один [1..1] элемент name
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(telecom) >= 0">(Требование: У3-4.1.3.1.2.1.2.3) Элемент
                representedOrganization МОЖЕТ содержать произвольное количество [0..*] элементов
                telecom
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(addr) = [0, 1]">(Требование: У3-4.1.3.1.2.1.2.4) Элемент
                representedOrganization МОЖЕТ содержать не более одного [0..1] элемента addr
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/id[not(@root = '1.2.643.100.3')][not(@root = '1.2.643.5.1.13.2.1.1.1504.101')][not(@root = '1.2.643.5.1.13.13.17.1.1')]">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.2.1.2.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/id[not(@root='1.2.643.100.3')][not(@root='1.2.643.5.1.13.2.1.1.1504.101')][not(@root='1.2.643.5.1.13.13.17.1.1')]
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@root != ''">(Требование: У3-4.1.3.1.2.1.2.1) Элемент id обязан содержать
                один атрибут @root с не пустым значением</assert>
            <assert test="count(@extension != '') = [0, 1]">(Требование: У3-4.1.3.1.2.1.2.1) Элемент
                id должен содержать один атрибут @extension с не пустым значением</assert>
            <assert
                test="
                    if (@extension) then
                        ...
                        (not(@extension))"
                >(Требование: У3-4.1.3.1.2.1.2.1) Элемент id должен содержать один атрибут
                @extension с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/name">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.2.1.2.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/name
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-4.1.3.1.2.1.2.2) Элемент name должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/telecom">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.2.1.2.3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/telecom
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(@use != '') = [0, 1]">(Требование: У3-4.1.3.1.2.1.2.3) Элемент
                telecom должен содержать один атрибут @use с не пустым значением</assert>
            <assert
                test="
                    if (@use) then
                        ...
                        (not(@use))"
                >(Требование: У3-4.1.3.1.2.1.2.3) Элемент telecom должен содержать один атрибут @use
                с не пустым значением</assert>
            <assert test="@value != ''">(Требование: У3-4.1.3.1.2.1.2.3) Элемент telecom обязан
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.2.1.2.4) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(@use != '') = [0, 1]">(Требование: У3-4.1.3.1.2.1.2.4) Элемент addr
                должен содержать один атрибут @use с не пустым значением</assert>
            <assert
                test="
                    if (@use) then
                        ...
                        (not(@use))"
                >(Требование: У3-4.1.3.1.2.1.2.4) Элемент addr должен содержать один атрибут @use с
                не пустым значением</assert>
            <assert test="count(streetAddressLine) = 1">(Требование: У3-4.1.3.1.2.1.2.4.1) Элемент
                addr ОБЯЗАН содержать один [1..1] элемент streetAddressLine
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(address:stateCode) = 1">(Требование: У3-4.1.3.1.2.1.2.4.2) Элемент
                addr ОБЯЗАН содержать один [1..1] элемент address:stateCode
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(postalCode) = 1">(Требование: У3-4.1.3.1.2.1.2.4.3) Элемент addr
                ДОЛЖЕН содержать один [1..1] элемент postalCode
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(fias:Address) = 1">(Требование: У3-4.1.3.1.2.1.2.4.4) Элемент addr
                ДОЛЖЕН содержать один [1..1] элемент fias:Address
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/streetAddressLine">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.2.1.2.4.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr/streetAddressLine
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-4.1.3.1.2.1.2.4.1) Элемент streetAddressLine
                должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/address:stateCode">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.2.1.2.4.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr/address:stateCode
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@codeSystem = ['1.2.643.5.1.13.13.99.2.206', '1.2.643.5.1.13.13.11.1093']"
                >(Требование: У3-4.1.3.1.2.1.2.4.2) Элемент address:stateCode обязан содержать один
                атрибут @codeSystem со значением "1.2.643.5.1.13.13.99.2.206"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-4.1.3.1.2.1.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @codeSystemName с не пустым
                значением</assert>
            <assert test="@code != ''">(Требование: У3-4.1.3.1.2.1.2.4.2) Элемент address:stateCode
                обязан содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-4.1.3.1.2.1.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @codeSystemVersion с не пустым
                значением</assert>
            <assert test="@displayName != ''">(Требование: У3-4.1.3.1.2.1.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @displayName с не пустым
                значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/postalCode[not(@nullFlavor)]">
            <assert test=". != ''">(Требование: У3-4.1.3.1.2.1.2.4.3) Элемент postalCode должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address[not(@nullFlavor)]">
            <assert test="count(fias:AOGUID) = 1">(Требование: У3-4.1.3.1.2.1.2.4.4.1) Элемент
                fias:Address ОБЯЗАН содержать один [1..1] элемент fias:AOGUID
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address) </assert>
            <assert test="count(fias:HOUSEGUID) = 1">(Требование: У3-4.1.3.1.2.1.2.4.4.2) Элемент
                fias:Address ДОЛЖЕН содержать один [1..1] элемент fias:HOUSEGUID
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address)
            </assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:AOGUID">
            <report test="@nullFlavor">(Требование: У3-4.1.3.1.2.1.2.4.4.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12456']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:AOGUID
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-4.1.3.1.2.1.2.4.4.1) Элемент fias:AOGUID должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12456']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:HOUSEGUID[not(@nullFlavor)]">
            <assert test=". != ''">(Требование: У3-4.1.3.1.2.1.2.4.4.2) Элемент fias:HOUSEGUID
                должен содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12411']">
            <report test="@nullFlavor">(Требование: У3-5) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12411']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12411']/observation">
            <report test="@nullFlavor">(Требование: У3-5.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12411']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-5.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12411']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-5.1.2) Элемент observation ОБЯЗАН
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12411']/observation/code">
            <report test="@nullFlavor">(Требование: У3-5.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12411']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12411'">(Требование: У3-5.1.1) Элемент code обязан содержать один
                атрибут @code со значением "12411"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-5.1.1) Элемент code обязан содержать один атрибут @codeSystem со
                значением "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12411']/observation/value">
            <report test="@nullFlavor">(Требование: У3-5.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12411']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'CD'">(Требование: У3-5.1.2) Элемент value обязан содержать
                один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = ['1.2.643.5.1.13.13.99.2.144', '1.2.643.5.1.13.2.1.1.508']"
                >(Требование: У3-5.1.2) Элемент value обязан содержать один атрибут @codeSystem со
                значением "1.2.643.5.1.13.13.99.2.144"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-5.1.2) Элемент value обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-5.1.2) Элемент value обязан содержать один
                атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-5.1.2) Элемент value обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-5.1.2) Элемент value обязан содержать
                один атрибут @displayName с не пустым значением</assert>
            <assert test="count(originalText) = [0, 1]">(Требование: У3-5.1.2.1) Элемент value МОЖЕТ
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12411']/observation/value/originalText">
            <report test="@nullFlavor">(Требование: У3-5.1.2.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12411']/observation/value/originalText
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-5.1.2.1) Элемент originalText должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12306']">
            <report test="@nullFlavor">(Требование: У3-6) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12306']/observation">
            <report test="@nullFlavor">(Требование: У3-6.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-6.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-6.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '12400']) >= 0"
                >(Требование: У3-6.1.3) Элемент observation МОЖЕТ содержать произвольное количество
                [0..*] элементов entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation)
            </assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12306']/observation/code">
            <report test="@nullFlavor">(Требование: У3-6.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12306'">(Требование: У3-6.1.1) Элемент code обязан содержать один
                атрибут @code со значением "12306"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12306']/observation/value">
            <report test="@nullFlavor">(Требование: У3-6.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'CD'">(Требование: У3-6.1.2) Элемент value обязан содержать
                один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = ['1.2.643.5.1.13.13.99.2.128', '1.2.643.5.1.13.2.1.1.516']"
                >(Требование: У3-6.1.2) Элемент value обязан содержать один атрибут @codeSystem со
                значением "1.2.643.5.1.13.13.99.2.128"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-6.1.2) Элемент value обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-6.1.2) Элемент value обязан содержать один
                атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-6.1.2) Элемент value обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-6.1.2) Элемент value обязан содержать
                один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12306']/observation/entryRelationship[observation/code/@code = '12400']">
            <report test="@nullFlavor">(Требование: У3-6.1.3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation/entryRelationship[observation/code/@code='12400']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-6.1.3) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-6.1.3.1) Элемент entryRelationship
                ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation/entryRelationship[observation/code/@code='12400'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12306']/observation/entryRelationship[observation/code/@code = '12400']/observation">
            <report test="@nullFlavor">(Требование: У3-6.1.3.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation/entryRelationship[observation/code/@code='12400']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-6.1.3.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-6.1.3.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-6.1.3.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation/entryRelationship[observation/code/@code='12400']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-6.1.3.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation/entryRelationship[observation/code/@code='12400']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12306']/observation/entryRelationship[observation/code/@code = '12400']/observation/code">
            <report test="@nullFlavor">(Требование: У3-6.1.3.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation/entryRelationship[observation/code/@code='12400']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12400'">(Требование: У3-6.1.3.1.1) Элемент code обязан содержать
                один атрибут @code со значением "12400"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-6.1.3.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-6.1.3.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-6.1.3.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-6.1.3.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12306']/observation/entryRelationship[observation/code/@code = '12400']/observation/value">
            <report test="@nullFlavor">(Требование: У3-6.1.3.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12306']/observation/entryRelationship[observation/code/@code='12400']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'CD'">(Требование: У3-6.1.3.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.11.1117', '11.2.643.5.1.13.2.1.1.1504.10', '2.16.840.1.113883.2.35.10.10']"
                >(Требование: У3-6.1.3.1.2) Элемент value обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.11.1117"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-6.1.3.1.2) Элемент value обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-6.1.3.1.2) Элемент value обязан содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-6.1.3.1.2) Элемент value обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-6.1.3.1.2) Элемент value обязан
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule
            ...
            <assert test="count(title) = 1">(Требование: У2-2.1.2) Элемент section ОБЯЗАН содержать
                один [1..1] элемент title
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section) </assert>
            <assert test="count(entry[observation/code/@code = '838']) = 1">(Требование: У3-7)
                Элемент section ОБЯЗАН содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У2-2.1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = 'DGN'">(Требование: У2-2.1.1) Элемент code обязан содержать один
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']">
            <report test="@nullFlavor">(Требование: У3-7) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(observation) = 1">(Требование: У3-7.1) Элемент entry ОБЯЗАН
                содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(text) = 1">(Требование: У3-7.1.2) Элемент observation ДОЛЖЕН
                содержать один [1..1] элемент text
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(effectiveTime) = [0, 1]">(Требование: У3-7.1.3) Элемент observation
                МОЖЕТ содержать не более одного [0..1] элемента effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.4) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '12303']) = 1"
                >(Требование: У3-7.1.5) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '8037']) = [0, 1]"
                >(Требование: У3-7.1.6) Элемент observation МОЖЕТ содержать не более одного [0..1]
                элемента entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '12302']) = 1"
                >(Требование: У3-7.1.7) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '12407']) = [0, 1]"
                >(Требование: У3-7.1.8) Элемент observation МОЖЕТ содержать не более одного [0..1]
                элемента entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '6047']) = 1"
                >(Требование: У3-7.1.9) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '6048']) = 1"
                >(Требование: У3-7.1.10) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '6049']) = 1"
                >(Требование: У3-7.1.11) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '6050']) = 1"
                >(Требование: У3-7.1.12) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '12305']) >= 0"
                >(Требование: У3-7.1.13) Элемент observation МОЖЕТ содержать произвольное количество
                [0..*] элементов entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '838'">(Требование: У3-7.1.1) Элемент code обязан содержать один
                атрибут @code со значением "838"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.1) Элемент code обязан содержать один атрибут @codeSystem со
                значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.1) Элемент code обязан содержать
                один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/text[not(@nullFlavor)]">
            <assert test=". != ''">(Требование: У3-7.1.2) Элемент text должен содержать не пустое
                текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/effectiveTime">
            <report test="@nullFlavor">(Требование: У3-7.1.3) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@value != ''">(Требование: У3-7.1.3) Элемент effectiveTime обязан
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/value">
            <report test="@nullFlavor">(Требование: У3-7.1.4) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.4) Элемент value обязан содержать
                один атрибут @xsi:type со значением "CD"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.11.1005', '1.2.643.5.1.13.2.1.1.641', '1.2.643.5.1.13.2.1.1.718']"
                >(Требование: У3-7.1.4) Элемент value обязан содержать один атрибут @codeSystem со
                значением "1.2.643.5.1.13.13.11.1005"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.4) Элемент value обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.4) Элемент value обязан содержать один
                атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.4) Элемент value обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.4) Элемент value обязан содержать
                один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12303']">
            <report test="@nullFlavor">(Требование: У3-7.1.5) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.5) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.5.1) Элемент entryRelationship
                ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12303']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.5.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.5.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.5.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.5.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.5.1.2) Элемент observation ДОЛЖЕН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '6034']) = 1"
                >(Требование: У3-7.1.5.1.3) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12303']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.5.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12303'">(Требование: У3-7.1.5.1.1) Элемент code обязан содержать
                один атрибут @code со значением "12303"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.5.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.5.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.5.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.5.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12303']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.5.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.11.1487'">(Требование: У3-7.1.5.1.2)
                Элемент value должен содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.11.1487"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.5.1.2) Элемент value должен
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.5.1.2) Элемент value должен содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.5.1.2) Элемент value должен
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.5.1.2) Элемент value должен
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12303']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.5.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12303']/observation/entryRelationship[observation/code/@code = '6034']">
            <report test="@nullFlavor">(Требование: У3-7.1.5.1.3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303']/observation/entryRelationship[observation/code/@code='6034']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.5.1.3) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.5.1.3.1) Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12303']/observation/entryRelationship[observation/code/@code = '6034']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.5.1.3.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303']/observation/entryRelationship[observation/code/@code='6034']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.5.1.3.1) Элемент observation
                обязан содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.5.1.3.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.5.1.3.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303']/observation/entryRelationship[observation/code/@code='6034']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.5.1.3.1.2) Элемент observation
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12303']/observation/entryRelationship[observation/code/@code = '6034']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.5.1.3.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12303']/observation/entryRelationship[observation/code/@code='6034']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '6034'">(Требование: У3-7.1.5.1.3.1.1) Элемент code обязан
                содержать один атрибут @code со значением "6034"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.5.1.3.1.1) Элемент code обязан содержать один атрибут
                @codeSystem со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.5.1.3.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.5.1.3.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.5.1.3.1.1) Элемент code
                обязан содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12303']/observation/entryRelationship[observation/code/@code = '6034']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.5.1.3.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.778'">(Требование: У3-7.1.5.1.3.1.2)
                Элемент value должен содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.778"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.5.1.3.1.2) Элемент value должен
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.5.1.3.1.2) Элемент value должен содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.5.1.3.1.2) Элемент value
                должен содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.5.1.3.1.2) Элемент value должен
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12303']/observation/entryRelationship[observation/code/@code = '6034']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.5.1.3.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <report test="@nullFlavor != 'NA'">Если признак латеральности неприменим, то атрибут value/nullFlavor должен быть представлен со значением 'NA'</report>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
            <report test="@displayName">Атрибут nullFlavor не должен быть представлен совместно с
                атрибутом @displayName</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '8037']">
            <report test="@nullFlavor">(Требование: У3-7.1.6) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.6) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.6.1) Элемент entryRelationship
                ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '8037']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.6.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.6.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.6.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.6.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.6.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '6034']) = 1"
                >(Требование: У3-7.1.6.1.3) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '8037']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.6.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '8037'">(Требование: У3-7.1.6.1.1) Элемент code обязан содержать
                один атрибут @code со значением "8037"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.6.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.6.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.6.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.6.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '8037']/observation/value">
            <report test="@nullFlavor">(Требование: У3-7.1.6.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.6.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.11.1477'">(Требование: У3-7.1.6.1.2)
                Элемент value обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.11.1477"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.6.1.2) Элемент value обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.6.1.2) Элемент value обязан содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.6.1.2) Элемент value обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.6.1.2) Элемент value обязан
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '8037']/observation/entryRelationship[observation/code/@code = '6034']">
            <report test="@nullFlavor">(Требование: У3-7.1.6.1.3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation/entryRelationship[observation/code/@code='6034']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.6.1.3) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.6.1.3.1) Элемент
                entryRelationship ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation/entryRelationship[observation/code/@code='6034'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '8037']/observation/entryRelationship[observation/code/@code = '6034']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.6.1.3.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation/entryRelationship[observation/code/@code='6034']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.6.1.3.1) Элемент observation
                обязан содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.6.1.3.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.6.1.3.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation/entryRelationship[observation/code/@code='6034']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.6.1.3.1.2) Элемент observation
                ДОЛЖЕН содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation/entryRelationship[observation/code/@code='6034']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '8037']/observation/entryRelationship[observation/code/@code = '6034']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.6.1.3.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='8037']/observation/entryRelationship[observation/code/@code='6034']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '6034'">(Требование: У3-7.1.6.1.3.1.1) Элемент code обязан
                содержать один атрибут @code со значением "6034"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.6.1.3.1.1) Элемент code обязан содержать один атрибут
                @codeSystem со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.6.1.3.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.6.1.3.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.6.1.3.1.1) Элемент code
                обязан содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '8037']/observation/entryRelationship[observation/code/@code = '6034']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.6.1.3.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.778'">(Требование: У3-7.1.6.1.3.1.2)
                Элемент value должен содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.778"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.6.1.3.1.2) Элемент value должен
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.6.1.3.1.2) Элемент value должен содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.6.1.3.1.2) Элемент value
                должен содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.6.1.3.1.2) Элемент value должен
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '8037']/observation/entryRelationship[observation/code/@code = '6034']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.6.1.3.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <report test="@nullFlavor != 'NA'">Если признак латеральности неприменим, то атрибут value/nullFlavor должен быть представлен со значением 'NA'</report>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12302']">
            <report test="@nullFlavor">(Требование: У3-7.1.7) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12302']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.7) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.7.1) Элемент entryRelationship
                ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12302'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12302']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.7.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12302']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.7.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.7.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.7.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12302']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.7.1.2) Элемент observation ДОЛЖЕН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12302']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12302']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.7.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12302']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12302'">(Требование: У3-7.1.7.1.1) Элемент code обязан содержать
                один атрибут @code со значением "12302"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.7.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.7.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.7.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.7.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12302']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.7.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.11.1486'">(Требование: У3-7.1.7.1.2)
                Элемент value должен содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.11.1486"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.7.1.2) Элемент value должен
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.7.1.2) Элемент value должен содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.7.1.2) Элемент value должен
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.7.1.2) Элемент value должен
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12302']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.7.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12407']">
            <report test="@nullFlavor">(Требование: У3-7.1.8) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12407']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.8) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.8.1) Элемент entryRelationship
                ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12407'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12407']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.8.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12407']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.8.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.8.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.8.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12407']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.8.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12407']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12407']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.8.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12407']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12407'">(Требование: У3-7.1.8.1.1) Элемент code обязан содержать
                один атрибут @code со значением "12407"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.8.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.8.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.8.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.8.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12407']/observation/value">
            <report test="@nullFlavor">(Требование: У3-7.1.8.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12407']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.8.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.1046'">(Требование: У3-7.1.8.1.2)
                Элемент value обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.1046"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.8.1.2) Элемент value обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.8.1.2) Элемент value обязан содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.8.1.2) Элемент value обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.8.1.2) Элемент value обязан
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6047']">
            <report test="@nullFlavor">(Требование: У3-7.1.9) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6047']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.9) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.9.1) Элемент entryRelationship
                ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6047'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6047']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.9.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6047']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.9.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.9.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.9.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6047']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.9.1.2) Элемент observation ДОЛЖЕН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6047']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6047']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.9.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6047']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '6047'">(Требование: У3-7.1.9.1.1) Элемент code обязан содержать
                один атрибут @code со значением "6047"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.9.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.9.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.9.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.9.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6047']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.9.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.547'">(Требование: У3-7.1.9.1.2)
                Элемент value должен содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.547"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.9.1.2) Элемент value должен
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.9.1.2) Элемент value должен содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.9.1.2) Элемент value должен
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.9.1.2) Элемент value должен
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6047']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.9.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <report test="@nullFlavor != 'NA'">Если при установленном морфологическом типе или локализации опухоли не предусмотрено стадирование процесса, то атрибут value/nullFlavor должен быть представлен со значением 'NA'</report>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
            <report test="@displayName">Атрибут nullFlavor не должен быть представлен совместно с
                атрибутом @displayName</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6048']">
            <report test="@nullFlavor">(Требование: У3-7.1.10) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6048']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.10) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.10.1) Элемент
                entryRelationship ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6048'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6048']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.10.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6048']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.10.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.10.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.10.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6048']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.10.1.2) Элемент observation ДОЛЖЕН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6048']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6048']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.10.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6048']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '6048'">(Требование: У3-7.1.10.1.1) Элемент code обязан содержать
                один атрибут @code со значением "6048"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.10.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.10.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.10.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.10.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6048']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.10.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.547'">(Требование: У3-7.1.10.1.2)
                Элемент value должен содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.547"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.10.1.2) Элемент value должен
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.10.1.2) Элемент value должен содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.10.1.2) Элемент value должен
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.10.1.2) Элемент value должен
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6048']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.10.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <report test="@nullFlavor != 'NA'">Если при установленном морфологическом типе или локализации опухоли не предусмотрено стадирование процесса, то атрибут value/nullFlavor должен быть представлен со значением 'NA'</report>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6049']">
            <report test="@nullFlavor">(Требование: У3-7.1.11) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6049']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.11) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.11.1) Элемент
                entryRelationship ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6049'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6049']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.11.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6049']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.11.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.11.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.11.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6049']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.11.1.2) Элемент observation ДОЛЖЕН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6049']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6049']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.11.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6049']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '6049'">(Требование: У3-7.1.11.1.1) Элемент code обязан содержать
                один атрибут @code со значением "6049"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.11.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.11.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.11.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.11.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6049']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.11.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.547'">(Требование: У3-7.1.11.1.2)
                Элемент value должен содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.547"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.11.1.2) Элемент value должен
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.11.1.2) Элемент value должен содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.11.1.2) Элемент value должен
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.11.1.2) Элемент value должен
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6049']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.11.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <report test="@nullFlavor != 'NA'">Если при установленном морфологическом типе или локализации опухоли не предусмотрено стадирование процесса, то атрибут value/nullFlavor должен быть представлен со значением 'NA'</report>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6050']">
            <report test="@nullFlavor">(Требование: У3-7.1.12) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6050']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.12) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.12.1) Элемент
                entryRelationship ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6050'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6050']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.12.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6050']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.12.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.12.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.12.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6050']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.12.1.2) Элемент observation ДОЛЖЕН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6050']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6050']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.12.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='6050']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '6050'">(Требование: У3-7.1.12.1.1) Элемент code обязан содержать
                один атрибут @code со значением "6050"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.12.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.12.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.12.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.12.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6050']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.12.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.546'">(Требование: У3-7.1.12.1.2)
                Элемент value должен содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.546"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.12.1.2) Элемент value должен
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.12.1.2) Элемент value должен содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.12.1.2) Элемент value должен
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.12.1.2) Элемент value должен
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '6050']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.12.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@nullFlavor = ['NA','UNK']">Если при установленном морфологическом типе или локализации опухоли не предусмотрено стадирование процесса, то атрибут value/nullFlavor должен быть представлен со значением 'NA'. 
                Если стадия опухолевого заболевания неизвестна, то атрибут value/nullFlavor должен быть представлен со значением 'UNK'</assert>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
            <report test="@displayName">Атрибут nullFlavor не должен быть представлен совместно с
                атрибутом @displayName</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12305']">
            <report test="@nullFlavor">(Требование: У3-7.1.13) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12305']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-7.1.13) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-7.1.13.1) Элемент
                entryRelationship ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12305'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12305']/observation">
            <report test="@nullFlavor">(Требование: У3-7.1.13.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12305']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-7.1.13.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-7.1.13.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-7.1.13.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12305']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-7.1.13.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12305']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12305']/observation/code">
            <report test="@nullFlavor">(Требование: У3-7.1.13.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12305']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12305'">(Требование: У3-7.1.13.1.1) Элемент code обязан содержать
                один атрибут @code со значением "12305"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-7.1.13.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.13.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.13.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.13.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@code = '838']/observation/entryRelationship[observation/code/@code = '12305']/observation/value">
            <report test="@nullFlavor">(Требование: У3-7.1.13.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='DGN']/section/entry[observation/code/@code='838']/observation/entryRelationship[observation/code/@code='12305']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'CD'">(Требование: У3-7.1.13.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = ['1.2.643.5.1.13.13.99.2.127', '1.2.643.5.1.13.2.1.1.517']"
                >(Требование: У3-7.1.13.1.2) Элемент value обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.127"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-7.1.13.1.2) Элемент value обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-7.1.13.1.2) Элемент value обязан содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-7.1.13.1.2) Элемент value обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-7.1.13.1.2) Элемент value обязан
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']">
            <report test="@nullFlavor">(Требование: У2-3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section">
            <report test="@nullFlavor">(Требование: У2-3.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(code) = 1">(Требование: У2-3.1.1) Элемент section ОБЯЗАН содержать
                один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section) </assert>
            <assert test="count(title) = 1">(Требование: У2-3.1.2) Элемент section ОБЯЗАН содержать
                один [1..1] элемент title
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section) </assert>
            <assert test="count(entry[observation/code/@code = '800']) >= 1">(Требование: У3-8)
                Элемент section ОБЯЗАН содержать не менее одного [1..*] элемента entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/code">
            <report test="@nullFlavor">(Требование: У2-3.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = 'STAGETREATMENT'">(Требование: У2-3.1.1) Элемент code обязан
                содержать один атрибут @code со значением "STAGETREATMENT"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.197', '1.2.643.5.1.13.2.1.1.1504.23', '1.2.643.5.1.13.13.11.1379']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/title">
            <report test="@nullFlavor">(Требование: У2-3.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/title
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']">
            <report test="@nullFlavor">(Требование: У3-8) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation">
            <report test="@nullFlavor">(Требование: У3-8.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-8.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation) </assert>
            <assert test="count(text) = [0, 1]">(Требование: У3-8.1.2) Элемент observation МОЖЕТ
                содержать не более одного [0..1] элемента text
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation) </assert>
            <assert test="count(effectiveTime) = 1">(Требование: У3-8.1.3) Элемент observation
                ДОЛЖЕН содержать один [1..1] элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-8.1.4) Элемент observation ДОЛЖЕН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '12016']) = 1"
                >(Требование: У3-8.1.5) Элемент observation ОБЯЗАН содержать один [1..1] элемент
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '12004']) = [0, 1]"
                >(Требование: У3-8.1.6) Элемент observation МОЖЕТ содержать не более одного [0..1]
                элемента entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '9038']) = [0, 1]"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/code">
            <report test="@nullFlavor">(Требование: У3-8.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '800'">(Требование: У3-8.1.1) Элемент code обязан содержать один
                атрибут @code со значением "800"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/text">
            <report test="@nullFlavor">(Требование: У3-8.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/text
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/effectiveTime[not(@nullFlavor)]">
            <assert test="@value != ''">(Требование: У3-8.1.3) Элемент effectiveTime должен
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/effectiveTime[@nullFlavor]">
            <report test="@value">Атрибут nullFlavor не должен быть представлен совместно с
                атрибутом @value</report>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-8.1.4) Элемент value обязан содержать
                один атрибут @xsi:type со значением "CD"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.11.1005', '1.2.643.5.1.13.2.1.1.641', '1.2.643.5.1.13.2.1.1.718']"
                >(Требование: У3-8.1.4) Элемент value должен содержать один атрибут @codeSystem со
                значением "1.2.643.5.1.13.13.11.1005"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-8.1.4) Элемент value должен
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-8.1.4) Элемент value должен содержать один
                атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-8.1.4) Элемент value должен
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-8.1.4) Элемент value должен содержать
                один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">(Требование: У3-8.1.4) Элемент value обязан содержать
                один атрибут @xsi:type со значением "CD"</assert>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12016']">
            <report test="@nullFlavor">(Требование: У3-8.1.5) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12016']/observation">
            <report test="@nullFlavor">(Требование: У3-8.1.5.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-8.1.5.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation) </assert>
            <assert test="count(performer) = 1">(Требование: У3-8.1.5.1.2) Элемент observation
                ОБЯЗАН содержать один [1..1] элемент performer
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12016']/observation/code">
            <report test="@nullFlavor">(Требование: У3-8.1.5.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12016'">(Требование: У3-8.1.5.1.1) Элемент code обязан содержать
                один атрибут @code со значением "12016"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer">
            <report test="@nullFlavor">(Требование: У3-8.1.5.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation/performer
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(assignedEntity) = 1">(Требование: У3-8.1.5.1.2.1) Элемент performer
                ОБЯЗАН содержать один [1..1] элемент assignedEntity
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation/performer)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity">
            <report test="@nullFlavor">(Требование: У3-8.1.5.1.2.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(id) = 1">(Требование: У3-8.1.5.1.2.1.1) Элемент assignedEntity
                ДОЛЖЕН содержать один [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity) </assert>
            <assert test="count(representedOrganization) = 1">(Требование: У3-8.1.5.1.2.1.2) Элемент
                assignedEntity ОБЯЗАН содержать один [1..1] элемент representedOrganization
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/id">
            <assert test="@nullFlavor = 'NI'">(Требование: У3-8.1.5.1.2.1.1) Элемент id обязан
                содержать один атрибут @nullFlavor со значением "NI"</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization">
            <report test="@nullFlavor">(Требование: У3-8.1.5.1.2.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'ORG'">(Требование: У3-8.1.5.1.2.1.2) Элемент
                representedOrganization обязан содержать один атрибут @classCode со значением
                "ORG"</assert>
            <assert test="count(id[1]) = 1">(Требование: У3-8.1.5.1.2.1.2.1) Элемент
                representedOrganization ДОЛЖЕН содержать один [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(name) = 1">(Требование: У3-8.1.5.1.2.1.2.2) Элемент
                representedOrganization ДОЛЖЕН содержать один [1..1] элемент name
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12016']/observation/performer/assignedEntity/representedOrganization)
            </assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/id[1][not(@nullFlavor)]">
            <assert test="@root != ''">(Требование: У3-8.1.5.1.2.1.2.1) Элемент id должен содержать
                один атрибут @root с не пустым значением</assert>
            <assert test="count(@extension != '') = [0, 1]">(Требование: У3-8.1.5.1.2.1.2.1) Элемент
                id должен содержать один атрибут @extension с не пустым значением</assert>
            <assert
                test="
                    if (@extension) then
                        ...
                        (not(@extension))"
                >(Требование: У3-8.1.5.1.2.1.2.1) Элемент id должен содержать один атрибут
                @extension с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/id[1][@nullFlavor]">
            <report test="@root">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @root</report>
            <report test="@extension">Атрибут nullFlavor не должен быть представлен совместно с
                атрибутом @extension</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12016']/observation/performer/assignedEntity/representedOrganization/name[not(@nullFlavor)]">
            <assert test=". != ''">(Требование: У3-8.1.5.1.2.1.2.2) Элемент name должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12004']">
            <report test="@nullFlavor">(Требование: У3-8.1.6) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12004']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12004']/observation">
            <report test="@nullFlavor">(Требование: У3-8.1.6.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12004']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-8.1.6.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12004']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-8.1.6.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12004']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12004']/observation/code">
            <report test="@nullFlavor">(Требование: У3-8.1.6.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12004']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12004'">(Требование: У3-8.1.6.1.1) Элемент code обязан содержать
                один атрибут @code со значением "12004"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '12004']/observation/value">
            <report test="@nullFlavor">(Требование: У3-8.1.6.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='12004']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'ST'">(Требование: У3-8.1.6.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "ST"</assert>
            <assert test=". != ''">(Требование: У3-8.1.6.1.2) Элемент value должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '9038']">
            <report test="@nullFlavor">(Требование: У3-8.1.7) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='9038']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '9038']/observation">
            <report test="@nullFlavor">(Требование: У3-8.1.7.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='9038']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-8.1.7.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='9038']/observation) </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '9038']/observation/code">
            <report test="@nullFlavor">(Требование: У3-8.1.7.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='9038']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '9038'">(Требование: У3-8.1.7.1.1) Элемент code обязан содержать
                один атрибут @code со значением "9038"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'STAGETREATMENT']/section/entry[observation/code/@code = '800']/observation/entryRelationship[observation/code/@code = '9038']/observation/value">
            <report test="@nullFlavor">(Требование: У3-8.1.7.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='STAGETREATMENT']/section/entry[observation/code/@code='800']/observation/entryRelationship[observation/code/@code='9038']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'ST'">(Требование: У3-8.1.7.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "ST"</assert>
            <assert test=". != ''">(Требование: У3-8.1.7.1.2) Элемент value должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']">
            <report test="@nullFlavor">(Требование: У2-4) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO'] не
                должен иметь атрибут @nullFlavor</report>
            <assert test="count(section) = 1">(Требование: У2-4.1) Элемент component ОБЯЗАН
                содержать один [1..1] элемент section
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO'])
            </assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section">
            <report test="@nullFlavor">(Требование: У2-4.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(code) = 1">(Требование: У2-4.1.1) Элемент section ОБЯЗАН содержать
                один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section) </assert>
            <assert test="count(title) = 1">(Требование: У2-4.1.2) Элемент section ОБЯЗАН содержать
                один [1..1] элемент title
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '12457']) = 1">(Требование: У3-9)
                Элемент section ОБЯЗАН содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/code">
            <report test="@nullFlavor">(Требование: У2-4.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = 'ORGINFO'">(Требование: У2-4.1.1) Элемент code обязан содержать
                один атрибут @code со значением "ORGINFO"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.197', '1.2.643.5.1.13.2.1.1.1504.23', '1.2.643.5.1.13.13.11.1379']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/title">
            <report test="@nullFlavor">(Требование: У2-4.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/title
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']">
            <report test="@nullFlavor">(Требование: У3-9) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(observation) = 1">(Требование: У3-9.1) Элемент entry ОБЯЗАН
                содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation">
            <report test="@nullFlavor">(Требование: У3-9.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-9.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-9.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-9.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation) </assert>
            <assert test="count(text) = [0, 1]">(Требование: У3-9.1.2) Элемент observation МОЖЕТ
                содержать не более одного [0..1] элемента text
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation) </assert>
            <assert test="count(effectiveTime) = 1">(Требование: У3-9.1.3) Элемент observation
                ОБЯЗАН содержать один [1..1] элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation) </assert>
            <assert test="count(performer) = 1">(Требование: У3-9.1.4) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент performer
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '8106']) = [0, 1]"
                >(Требование: У3-9.1.5) Элемент observation МОЖЕТ содержать не более одного [0..1]
                элемента entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '10000']) = [0, 1]"
                >(Требование: У3-9.1.6) Элемент observation МОЖЕТ содержать не более одного [0..1]
                элемента entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/code">
            <report test="@nullFlavor">(Требование: У3-9.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12457'">(Требование: У3-9.1.1) Элемент code обязан содержать один
                атрибут @code со значением "12457"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-9.1.1) Элемент code обязан содержать один атрибут @codeSystem со
                значением "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/text">
            <report test="@nullFlavor">(Требование: У3-9.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/text
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/effectiveTime">
            <report test="@nullFlavor">(Требование: У3-9.1.3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/effectiveTime
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer">
            <report test="@nullFlavor">(Требование: У3-9.1.4) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(assignedEntity) = 1">(Требование: У3-9.1.4.1) Элемент performer
                ОБЯЗАН содержать один [1..1] элемент assignedEntity
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity">
            <report test="@nullFlavor">(Требование: У3-9.1.4.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(id) = 1">(Требование: У3-9.1.4.1.1) Элемент assignedEntity ДОЛЖЕН
                содержать один [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity) </assert>
            <assert test="count(representedOrganization) = 1">(Требование: У3-9.1.4.1.2) Элемент
                assignedEntity ОБЯЗАН содержать один [1..1] элемент representedOrganization
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/id">
            <assert test="@nullFlavor = 'NI'">(Требование: У3-9.1.4.1.1) Элемент id обязан содержать
                один атрибут @nullFlavor со значением "NI"</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization">
            <report test="@nullFlavor">(Требование: У3-9.1.4.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'ORG'">(Требование: У3-9.1.4.1.2) Элемент
                representedOrganization обязан содержать один атрибут @classCode со значением
                "ORG"</assert>
            <assert
                test="count(id[not(@root = '1.2.643.100.3')][not(@root = '1.2.643.5.1.13.2.1.1.1504.101')][not(@root = '1.2.643.5.1.13.13.17.1.1')]) = 1"
                >(Требование: У3-9.1.4.1.2.1) Элемент representedOrganization ОБЯЗАН содержать один
                [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(name) = 1">(Требование: У3-9.1.4.1.2.2) Элемент
                representedOrganization ОБЯЗАН содержать один [1..1] элемент name
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(telecom) >= 0">(Требование: У3-9.1.4.1.2.3) Элемент
                representedOrganization МОЖЕТ содержать произвольное количество [0..*] элементов
                telecom
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(addr) = [0, 1]">(Требование: У3-9.1.4.1.2.4) Элемент
                representedOrganization МОЖЕТ содержать не более одного [0..1] элемента addr
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization/id[not(@root = '1.2.643.100.3')][not(@root = '1.2.643.5.1.13.2.1.1.1504.101')][not(@root = '1.2.643.5.1.13.13.17.1.1')]">
            <report test="@nullFlavor">(Требование: У3-9.1.4.1.2.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/id[not(@root='1.2.643.100.3')][not(@root='1.2.643.5.1.13.2.1.1.1504.101')][not(@root='1.2.643.5.1.13.13.17.1.1')]
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@root != ''">(Требование: У3-9.1.4.1.2.1) Элемент id обязан содержать один
                атрибут @root с не пустым значением</assert>
            <assert test="count(@extension != '') = [0, 1]">(Требование: У3-9.1.4.1.2.1) Элемент id
                должен содержать один атрибут @extension с не пустым значением</assert>
            <assert
                test="
                    if (@extension) then
                        ...
                        (not(@extension))"
                >(Требование: У3-9.1.4.1.2.1) Элемент id должен содержать один атрибут @extension с
                не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization/name">
            <report test="@nullFlavor">(Требование: У3-9.1.4.1.2.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/name
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-9.1.4.1.2.2) Элемент name должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization/telecom">
            <report test="@nullFlavor">(Требование: У3-9.1.4.1.2.3) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/telecom
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(@use != '') = [0, 1]">(Требование: У3-9.1.4.1.2.3) Элемент telecom
                должен содержать один атрибут @use с не пустым значением</assert>
            <assert
                test="
                    if (@use) then
                        ...
                        (not(@use))"
                >(Требование: У3-9.1.4.1.2.3) Элемент telecom должен содержать один атрибут @use с
                не пустым значением</assert>
            <assert test="@value != ''">(Требование: У3-9.1.4.1.2.3) Элемент telecom обязан
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization/addr">
            <report test="@nullFlavor">(Требование: У3-9.1.4.1.2.4) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/addr
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(@use != '') = [0, 1]">(Требование: У3-9.1.4.1.2.4) Элемент addr
                должен содержать один атрибут @use с не пустым значением</assert>
            <assert
                test="
                    if (@use) then
                        ...
                        (not(@use))"
                >(Требование: У3-9.1.4.1.2.4) Элемент addr должен содержать один атрибут @use с не
                пустым значением</assert>
            <assert test="count(streetAddressLine) = 1">(Требование: У3-9.1.4.1.2.4.1) Элемент addr
                ОБЯЗАН содержать один [1..1] элемент streetAddressLine
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(address:stateCode) = 1">(Требование: У3-9.1.4.1.2.4.2) Элемент addr
                ОБЯЗАН содержать один [1..1] элемент address:stateCode
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(postalCode) = 1">(Требование: У3-9.1.4.1.2.4.3) Элемент addr ДОЛЖЕН
                содержать один [1..1] элемент postalCode
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(fias:Address) = 1">(Требование: У3-9.1.4.1.2.4.4) Элемент addr
                ДОЛЖЕН содержать один [1..1] элемент fias:Address
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/addr)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization/addr/streetAddressLine">
            <report test="@nullFlavor">(Требование: У3-9.1.4.1.2.4.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/addr/streetAddressLine
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-9.1.4.1.2.4.1) Элемент streetAddressLine должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization/addr/address:stateCode">
            <report test="@nullFlavor">(Требование: У3-9.1.4.1.2.4.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/addr/address:stateCode
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@codeSystem = ['1.2.643.5.1.13.13.99.2.206', '1.2.643.5.1.13.13.11.1093']"
                >(Требование: У3-9.1.4.1.2.4.2) Элемент address:stateCode обязан содержать один
                атрибут @codeSystem со значением "1.2.643.5.1.13.13.99.2.206"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-9.1.4.1.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @codeSystemName с не пустым
                значением</assert>
            <assert test="@code != ''">(Требование: У3-9.1.4.1.2.4.2) Элемент address:stateCode
                обязан содержать один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-9.1.4.1.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @codeSystemVersion с не пустым
                значением</assert>
            <assert test="@displayName != ''">(Требование: У3-9.1.4.1.2.4.2) Элемент
                address:stateCode обязан содержать один атрибут @displayName с не пустым
                значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization/addr/postalCode[not(@nullFlavor)]">
            <assert test=". != ''">(Требование: У3-9.1.4.1.2.4.3) Элемент postalCode должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address[not(@nullFlavor)]">
            <assert test="count(fias:AOGUID) = 1">(Требование: У3-9.1.4.1.2.4.4.1) Элемент
                fias:Address ОБЯЗАН содержать один [1..1] элемент fias:AOGUID
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address) </assert>
            <assert test="count(fias:HOUSEGUID) = 1">(Требование: У3-9.1.4.1.2.4.4.2) Элемент
                fias:Address ДОЛЖЕН содержать один [1..1] элемент fias:HOUSEGUID
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address)
            </assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:AOGUID">
            <report test="@nullFlavor">(Требование: У3-9.1.4.1.2.4.4.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:AOGUID
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-9.1.4.1.2.4.4.1) Элемент fias:AOGUID должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:HOUSEGUID[not(@nullFlavor)]">
            <assert test=". != ''">(Требование: У3-9.1.4.1.2.4.4.2) Элемент fias:HOUSEGUID должен
                содержать не пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/entryRelationship[observation/code/@code = '8106']">
            <report test="@nullFlavor">(Требование: У3-9.1.5) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/entryRelationship[observation/code/@code='8106']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/entryRelationship[observation/code/@code = '8106']/observation">
            <report test="@nullFlavor">(Требование: У3-9.1.5.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/entryRelationship[observation/code/@code='8106']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-9.1.5.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/entryRelationship[observation/code/@code='8106']/observation) </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/entryRelationship[observation/code/@code = '8106']/observation/code">
            <report test="@nullFlavor">(Требование: У3-9.1.5.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/entryRelationship[observation/code/@code='8106']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '8106'">(Требование: У3-9.1.5.1.1) Элемент code обязан содержать
                один атрибут @code со значением "8106"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/entryRelationship[observation/code/@code = '8106']/observation/value">
            <report test="@nullFlavor">(Требование: У3-9.1.5.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/entryRelationship[observation/code/@code='8106']/observation/value
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/entryRelationship[observation/code/@code = '10000']">
            <report test="@nullFlavor">(Требование: У3-9.1.6) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/entryRelationship[observation/code/@code='10000']
                не должен иметь атрибут @nullFlavor</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/entryRelationship[observation/code/@code = '10000']/observation">
            <report test="@nullFlavor">(Требование: У3-9.1.6.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/entryRelationship[observation/code/@code='10000']/observation
                не должен иметь атрибут @nullFlavor</report>
            ...
            <assert test="count(code) = 1">(Требование: У3-9.1.6.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/entryRelationship[observation/code/@code='10000']/observation) </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/entryRelationship[observation/code/@code = '10000']/observation/code">
            <report test="@nullFlavor">(Требование: У3-9.1.6.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/entryRelationship[observation/code/@code='10000']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '10000'">(Требование: У3-9.1.6.1.1) Элемент code обязан содержать
                один атрибут @code со значением "10000"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'ORGINFO']/section/entry[observation/code/@code = '12457']/observation/entryRelationship[observation/code/@code = '10000']/observation/value">
            <report test="@nullFlavor">(Требование: У3-9.1.6.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='ORGINFO']/section/entry[observation/code/@code='12457']/observation/entryRelationship[observation/code/@code='10000']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'ST'">(Требование: У3-9.1.6.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "ST"</assert>
            <assert test=". != ''">(Требование: У3-9.1.6.1.2) Элемент value должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule
            ...
            <assert test="count(title) = 1">(Требование: У2-5.1.2) Элемент section ОБЯЗАН содержать
                ...
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section) </assert>
            <assert
                test="count(entry[act/code/@codeSystem = ['1.2.643.5.1.13.13.99.2.1079', '1.2.643.5.1.13.13.11.1522','1.2.643.5.1.13.2.1.1.646','1.2.643.5.1.13.13.11.1115', '1.2.643.5.1.13.13.99.2.195']]) >= 1"
                >(Требование: У3-10) Элемент section ОБЯЗАН содержать не менее одного [1..*]
                элемента entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У2-5.1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = 'LINKDOCS'">(Требование: У2-5.1.1) Элемент code обязан содержать
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert
                test="count(act[code/@codeSystem = ['1.2.643.5.1.13.13.99.2.1079', '1.2.643.5.1.13.13.11.1522','1.2.643.5.1.13.2.1.1.646','1.2.643.5.1.13.13.11.1115', '1.2.643.5.1.13.13.99.2.195']]) = 1"
                >(Требование: У3-10.1) Элемент entry ОБЯЗАН содержать один [1..1] элемент act
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']])
            </assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'ACT'">(Требование: У3-10.1) Элемент act обязан содержать
                один атрибут @classCode со значением "ACT"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-10.1) Элемент act обязан содержать один
                атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-10.1.1) Элемент act ОБЯЗАН содержать один
                [1..1] элемент code
            ...
            <assert test="count(text) = [0, 1]">(Требование: У3-10.1.2) Элемент act МОЖЕТ содержать
                не более одного [0..1] элемента text
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]) </assert>
            <assert test="count(effectiveTime) = 1">(Требование: У3-10.1.3) Элемент act ОБЯЗАН
                содержать один [1..1] элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '11002']) = [0, 1]"
                >(Требование: У3-10.1.4) Элемент act МОЖЕТ содержать не более одного [0..1] элемента
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '11003']) = [0, 1]"
                >(Требование: У3-10.1.5) Элемент act МОЖЕТ содержать не более одного [0..1] элемента
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '6058']) = [0, 1]"
                >(Требование: У3-10.1.6) Элемент act МОЖЕТ содержать не более одного [0..1] элемента
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]) </assert>
            <assert test="count(reference) = 1">(Требование: У3-10.1.7) Элемент act ОБЯЗАН содержать
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code != ''">(Требование: У3-10.1.1) Элемент code обязан содержать один
                атрибут @code с не пустым значением</assert>
            <assert test="@codeSystem != ''">(Требование: У3-10.1.1) Элемент code обязан содержать
            ...
            <assert
                ...
                >(Требование: У3-10.1.1) Элемент code обязан содержать один атрибут @codeSystem с не
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.2) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test=". != ''">(Требование: У3-10.1.2) Элемент text должен содержать не пустое
                текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.3) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@value != ''">(Требование: У3-10.1.3) Элемент effectiveTime обязан
                содержать один атрибут @value с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.4) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-10.1.4) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-10.1.4.1) Элемент
                entryRelationship ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='11002'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.4.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-10.1.4.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-10.1.4.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-10.1.4.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='11002']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-10.1.4.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='11002']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.4.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='11002']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11002'">(Требование: У3-10.1.4.1.1) Элемент code обязан содержать
                один атрибут @code со значением "11002"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-10.1.4.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-10.1.4.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-10.1.4.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-10.1.4.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.4.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='11002']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'ST'">(Требование: У3-10.1.4.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "ST"</assert>
            <assert test=". != ''">(Требование: У3-10.1.4.1.2) Элемент value должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.5) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-10.1.5) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-10.1.5.1) Элемент
                entryRelationship ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='11003'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = ['1.2.643.5.1.13.13.99.2.1079', '1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem = ['1.2.643.5.1.13.13.99.2.1079', '1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code = '11003']/observation">
            <report test="@nullFlavor">(Требование: У3-10.1.5.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-10.1.5.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-10.1.5.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-10.1.5.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='11003']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-10.1.5.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='11003']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.5.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='11003']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11003'">(Требование: У3-10.1.5.1.1) Элемент code обязан содержать
                один атрибут @code со значением "11003"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-10.1.5.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-10.1.5.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-10.1.5.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-10.1.5.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.5.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='11003']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'ST'">(Требование: У3-10.1.5.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "ST"</assert>
            <assert test=". != ''">(Требование: У3-10.1.5.1.2) Элемент value должен содержать не
                пустое текстовое наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.6) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'COMP'">(Требование: У3-10.1.6) Элемент entryRelationship
                обязан содержать один атрибут @typeCode со значением "COMP"</assert>
            <assert test="count(observation) = 1">(Требование: У3-10.1.6.1) Элемент
                entryRelationship ОБЯЗАН содержать один [1..1] элемент observation
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='6058'])
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'LINKDOCS']/section/entry[act/code/@codeSystem = ['1.2.643.5.1.13.13.99.2.1079', '1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem = ['1.2.643.5.1.13.13.99.2.1079', '1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code = '6058']/observation">
            <report test="@nullFlavor">(Требование: У3-10.1.6.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'OBS'">(Требование: У3-10.1.6.1) Элемент observation обязан
                содержать один атрибут @classCode со значением "OBS"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-10.1.6.1) Элемент observation обязан
                содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(code) = 1">(Требование: У3-10.1.6.1.1) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='6058']/observation) </assert>
            <assert test="count(value) = 1">(Требование: У3-10.1.6.1.2) Элемент observation ОБЯЗАН
                содержать один [1..1] элемент value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='6058']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.6.1.1) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='6058']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '6058'">(Требование: У3-10.1.6.1.1) Элемент code обязан содержать
                один атрибут @code со значением "6058"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >(Требование: У3-10.1.6.1.1) Элемент code обязан содержать один атрибут @codeSystem
                со значением "1.2.643.5.1.13.13.99.2.166"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-10.1.6.1.1) Элемент code обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-10.1.6.1.1) Элемент code обязан
                содержать один атрибут @displayName с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-10.1.6.1.1) Элемент code обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.6.1.2) Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/entryRelationship[observation/code/@code='6058']/observation/value
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'CD'">(Требование: У3-10.1.6.1.2) Элемент value обязан
                содержать один атрибут @xsi:type со значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.1008'">(Требование: У3-10.1.6.1.2)
                Элемент value обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.1008"</assert>
            <assert test="@codeSystemName != ''">(Требование: У3-10.1.6.1.2) Элемент value обязан
                содержать один атрибут @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">(Требование: У3-10.1.6.1.2) Элемент value обязан содержать
                один атрибут @code с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">(Требование: У3-10.1.6.1.2) Элемент value обязан
                содержать один атрибут @codeSystemVersion с не пустым значением</assert>
            <assert test="@displayName != ''">(Требование: У3-10.1.6.1.2) Элемент value обязан
                содержать один атрибут @displayName с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.7) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@typeCode = 'REFR'">(Требование: У3-10.1.7) Элемент reference обязан
                содержать один атрибут @typeCode со значением "REFR"</assert>
            <assert test="count(externalDocument) = 1">(Требование: У3-10.1.7.1) Элемент reference
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">(Требование: У3-10.1.7.1) Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@classCode = 'DOCCLIN'">(Требование: У3-10.1.7.1) Элемент externalDocument
                обязан содержать один атрибут @classCode со значением "DOCCLIN"</assert>
            <assert test="@moodCode = 'EVN'">(Требование: У3-10.1.7.1) Элемент externalDocument
                обязан содержать один атрибут @moodCode со значением "EVN"</assert>
            <assert test="count(id[1]) = 1">(Требование: У3-10.1.7.1.1) Элемент externalDocument
                ДОЛЖЕН содержать один [1..1] элемент id
            ...
            <assert test="count(id[2]) = 1">(Требование: У3-10.1.7.1.2) Элемент externalDocument
                ДОЛЖЕН содержать один [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='LINKDOCS']/section/entry[act/code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/act[code/@codeSystem=['1.2.643.5.1.13.13.99.2.1079','1.2.643.5.1.13.13.11.1522']]/reference/externalDocument)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            ...
            <assert test="@root != ''">(Требование: У3-10.1.7.1.1) Элемент id должен содержать один
                атрибут @root с не пустым значением; допустимый формат значения:
                OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.51</assert>
            <assert test="matches(@root, '^[0-2](\.([1-9][0-9]*|0))+\.51$')">(Требование:
                У3-10.1.7.1.1) Элемент id должен содержать один атрибут @root с не пустым значением;
                допустимый формат значения:
                OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.51</assert>
            <assert test="@extension != ''">(Требование: У3-10.1.7.1.1) Элемент id должен содержать
                один атрибут @extension с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule
            ...
            <assert test="@root = '1.2.643.5.1.13.13.17.1.1'">(Требование: У3-10.1.7.1.2) Элемент id
                должен содержать один атрибут @root со значением "1.2.643.5.1.13.13.17.1.1"</assert>
            <assert test="@extension != ''">(Требование: У3-10.1.7.1.2) Элемент id должен содержать
                один атрибут @extension с не пустым значением</assert>
        </rule>
    </pattern>
    <pattern>
