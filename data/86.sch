...
-->
    ...
    <pattern>
        ...
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DISABILITY']/entry/observation">
            ...
            <assert test="count(entryRelationship[observation/code[@code!='816'][@code!='12013']])=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DISABILITY']/entry/observation должен иметь 1 элемент entryRelationship.</assert>
