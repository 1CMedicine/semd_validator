...
В файло с OID? исключамых из проверки, добавляются очень большие справочники, а также справочники, для которых displayName не может быть проверен по описанному выше алгоритму.
