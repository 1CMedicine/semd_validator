<!-- Схематрон для СЭМД "Предоперационный эпикриз (CDA) Редакция 1" -->
<!-- Разработано в соотвествии с Руководством по реализации: https://portal.egisz.rosminzdrav.ru/materials/4107 -->

<!-- Список изменений -->
<!-- 19.06.2023 - v.1.0.0: Схематрон разработан -->
<!-- 01.09.2023 - v.1.1.1: Скорректировано правило проверки для требования У3-9; скорректирован блок Core10-1 -->
...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        <rule context="ClinicalDocument/participant[@typeCode='IND']/associatedEntity[identity:DocInfo[identity:IdentityDocType/@code='3']/identity:INN]">
            ...
            <report test="identity:DocInfo/identity:INN/@nullFlavor">У1-18. Элемент ClinicalDocument/participant/associatedEntity/identity:DocInfo/identity:INN не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <!-- Main08 -->
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/documentationOf/serviceEvent/code">
            <assert test="@code='34'">У1-19. Элемент ClinicalDocument/documentationOf/serviceEvent/code должен иметь значение атрибута @code равное '34'.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/templateId">
            <assert test="@root='1.2.643.5.1.13.13.14.345.9.1'">У1-3. Элемент ClinicalDocument/templateId должен иметь значение атрибута @root равное '1.2.643.5.1.13.13.14.345.9.1'.</assert>
        </rule>
    </pattern>
    <!-- У1-5 -->
    <pattern>
        <rule context="ClinicalDocument/code">
            <assert test="@code='345'">У1-5. Элемент ClinicalDocument/code должен иметь значение атрибута @code равное '345'.</assert>
        </rule>
    </pattern>
    <!-- У2-1 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            <assert test="count(component[section/code/@code='ANAM'])&lt;=1">У2-1. Элемент ClinicalDocument/component/structuredBody должен иметь не более 1 элемента component[section/code/@code='ANAM'].</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            <assert test="count(component[section/code/@code='LANAM'])&lt;=1">У2-2. Элемент ClinicalDocument/component/structuredBody должен иметь не более 1 элемента component[section/code/@code='LANAM'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']">
            <assert test="count(text)=1">У2-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <!-- У2-3 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            <assert test="count(component[section/code/@code='PATOBJ'])&lt;=1">У2-3. Элемент ClinicalDocument/component/structuredBody должен иметь не более 1 элемента component[section/code/@code='PATOBJ'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PATOBJ']">
            <assert test="count(text)=1">У2-3. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PATOBJ'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <!-- У2-4 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            <assert test="count(component[section/code/@code='DGN'])=1">У2-4. Элемент ClinicalDocument/component/structuredBody должен иметь 1 элемент component[section/code/@code='DGN'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']">
            <assert test="count(text)=1">У2-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <!-- У2-5 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            <assert test="count(component[section/code/@code='PROC'])=1">У2-5. Элемент ClinicalDocument/component/structuredBody должен иметь 1 элемент component[section/code/@code='PROC'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']">
            <assert test="count(text)=1">У2-5. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']">
            <assert test="count(text)=1">У2-5. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']">
            <assert test="count(text)=1">У2-5. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']">
            <assert test="count(text)=1">У2-5. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']">
            <assert test="count(text)=1">У2-5. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <!-- У2-6 -->
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUM']/component/section[code/@code='DRUG']">
            <assert test="count(text)=1">У2-6. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUM']/component/section[code/@code='DRUG'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUM']/component/section[code/@code='NONDRUG']">
            <assert test="count(text)=1">У2-6. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUM']/component/section[code/@code='NONDRUG'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUM']/component/section[code/@code='POLT']">
            <assert test="count(text)=1">У2-6. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUM']/component/section[code/@code='POLT'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUM']/component/section[code/@code='RADIOTHERAPY']">
            <assert test="count(text)=1">У2-6. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUM']/component/section[code/@code='RADIOTHERAPY'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <!-- У2-7 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']">
            <assert test="count(text)=1">У2-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <!-- У2-8 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            <assert test="count(component[section/code/@code='PLANSUR'])=1">У2-8. Элемент ClinicalDocument/component/structuredBody должен иметь 1 элемент component[section/code/@code='PLANSUR'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']">
            <assert test="count(text)=1">У2-8. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <!-- У2-9 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']">
            <assert test="count(text)=1">У2-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <!-- У2-10 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            <assert test="count(component[section/code/@code='LINKDOCS'])&lt;=1">У2-10. Элемент ClinicalDocument/component/structuredBody должен иметь не более 1 элемента component[section/code/@code='LINKDOCS'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LINKDOCS']">
            <assert test="count(text)=1">У2-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LINKDOCS'] должен иметь 1 элемент text.</assert>
        </rule>
    </pattern>
    <!-- У3-1 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']">
            <assert test="count(entry[observation/code/@code='7006'])=1">У3-1. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM'] должен иметь 1 элемент entry[observation/code/@code='7006'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[code/@code='7006']">
            <assert test="count(value)=1">У3-1. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[code/@code='7006'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation/code[@code='7006']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[code/@code='7006']/value">
            <assert test="@xsi:type='ST'">У3-1. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[code/@code='7006']/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <report test="@nullFlavor">У3-1. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[code/@code='7006']/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <!-- У3-2 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[effectiveTime]">
            <assert test="count(effectiveTime)=1">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[effectiveTime] должен иметь 1 элемент effectiveTime.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[effectiveTime]/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1053','1.2.643.5.1.13.2.1.1.702']">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[effectiveTime]/code должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1053' или '1.2.643.5.1.13.2.1.1.702'.</assert>
            <assert test="count(qualifier)&lt;=1">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[effectiveTime]/code должен иметь не более 1 элемента qualifier.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[effectiveTime]/code/qualifier/value">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1041']">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[effectiveTime]/code/qualifier/value должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1041'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[effectiveTime]/value">
            <assert test="@xsi:type='ST'">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[effectiveTime]/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <report test="@nullFlavor">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation[effectiveTime]/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation/effectiveTime">
            <assert test="count(low)=1">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation/effectiveTime должен иметь 1 элемент low.</assert>
            <assert test="count(high)&lt;=1">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation/effectiveTime должен иметь не более 1 элемента high.</assert>
            <report test="@nullFlavor">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation/effectiveTime/high">
            <report test="@nullFlavor">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LANAM']/entry/observation/effectiveTime/high не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='HOSP']/component/section[code/@code='LANAM']">
            <assert test="count(entry[observation/code[@codeSystem=['1.2.643.5.1.13.13.11.1038']]])&lt;=1">У3-5. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='HOSP']/component/section[code/@code='LANAM'] должен иметь не более 1 элемента entry[observation/code[@codeSystem=['1.2.643.5.1.13.13.11.1038']]].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='HOSP']/component/section[code/@code='LANAM']/entry/observation[code[@codeSystem=['1.2.643.5.1.13.13.11.1038']]]">
            <assert test="count(text)&lt;=1">У3-5. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='HOSP']/component/section[code/@code='LANAM']/entry/observation[code[@codeSystem=['1.2.643.5.1.13.13.11.1038']]] должен иметь не более 1 элемента text.</assert>
        </rule>
    </pattern>
    ...
    <!-- У3-7 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']">
            <assert test="count(entry[observation/effectiveTime])=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ'] должен иметь 1 элемент entry[observation/effectiveTime].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]">
            <assert test="count(effectiveTime)=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime] должен иметь 1 элемент effectiveTime.</assert>
            <assert test="count(performer)=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime] должен иметь 1 элемент performer.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/code">
            <assert test="@nullFlavor='NI'">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/code должен иметь значение атрибута @nullFlavor равное 'NI'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation/effectiveTime">
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer">
            <assert test="count(modeCode)=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer должен иметь 1 элемент modeCode.</assert>
            <assert test="count(assignedEntity)=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer должен иметь 1 элемент assignedEntity.</assert>
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/modeCode">
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/modeCode не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity">
            <assert test="count(id[@root!='1.2.643.100.3'])&lt;=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь не более 1 элемента id[@root!='1.2.643.100.3'].</assert>
            <assert test="count(id[@root='1.2.643.100.3'])&lt;=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь не более 1 элемента id[@root='1.2.643.100.3'].</assert>
            <assert test="count(code)=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь 1 элемент code.</assert>
            <assert test="count(addr)&lt;=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь не более 1 элемента addr.</assert>
            <assert test="count(assignedPerson)&lt;=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь не более 1 элемента assignedPerson.</assert>
            <assert test="count(representedOrganization)&lt;=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь не более 1 элемента representedOrganization.</assert>
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/id[@root!='1.2.643.100.3']">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.70$')">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/id[@root!='1.2.643.100.3'] должен иметь синтаксически корректное значение атрибута @root, сформированное по правилу формирования идентификаторов персонала, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.70".</assert>
            <assert test="@extension!=''">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/id[@root!='1.2.643.100.3'] должен иметь не пустое значение атрибута @extension.</assert>
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/id[@root!='1.2.643.100.3'] не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/id[@root='1.2.643.100.3']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1002','1.2.643.5.1.13.2.1.1.733']">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/code должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1002' или '1.2.643.5.1.13.2.1.1.733'.</assert>
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/code не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/addr">
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/addr не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson">
            <assert test="count(name)=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson должен иметь 1 элемент name.</assert>
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson/name">
            <assert test="count(family)=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson/name должен иметь 1 элемент family.</assert>
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson/name не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization">
            <assert test="@classCode='ORG'">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization должен иметь значение атрибута @classCode равное 'ORG'.</assert>
            <assert test="count(id)=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization должен иметь 1 элемент id.</assert>
            <assert test="count(name)=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization должен иметь 1 элемент name.</assert>
            <assert test="count(addr)&lt;=1">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization должен иметь не более 1 элемента addr.</assert>
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization/id">
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization/id не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization/addr">
            <report test="@nullFlavor">У3-7. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization/addr не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <!-- У3-8 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']">
            <assert test="count(entry[observation/code/@code='837'])=1">У3-8. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ'] должен иметь 1 элемент entry[observation/code/@code='837'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[code/@code='837']">
            <assert test="count(value)=1">У3-8. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[code/@code='837'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation/code[@code='837']">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.166','1.2.643.5.1.13.2.1.1.1504.41','1.2.643.5.1.13.13.11.1380']">У3-8. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation/code[@code='837'] должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41' или '1.2.643.5.1.13.13.11.1380'.</assert>
            <report test="@nullFlavor">У3-8. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation/code[@code='837'] не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[code/@code='837']/value[not(@nullFlavor)]">
            <assert test="@xsi:type='ST'">У3-8. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='STATEADM']/component/section[code/@code='PATOBJ']/entry/observation[code/@code='837']/value должен иметь значение атрибута @xsi:type равное 'ST'.</assert>
        </rule>
    </pattern>
    <!-- У3-9 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']">
            <assert test="count(entry[observation/code/@code='838'])>=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN'] должен иметь не менее 1 элемента entry[observation/code/@code='838'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']">
            <assert test="count(entryRelationship[observation])=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838'] должен иметь 1 элемент entryRelationship[observation].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation/code[@code='838']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation">
            <assert test="count(text)&lt;=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation должен иметь не более 1 элемента text.</assert>
            ...
            <assert test="count(entryRelationship[observation/code/@code='6047'])&lt;=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation должен иметь не более 1 элемента entryRelationship[observation/code/@code='6047'].</assert>
            <assert test="count(entryRelationship[observation/code/@code='6048'])&lt;=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation должен иметь не более 1 элемента entryRelationship[observation/code/@code='6048'].</assert>
            <assert test="count(entryRelationship[observation/code/@code='6049'])&lt;=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation должен иметь не более 1 элемента entryRelationship[observation/code/@code='6049'].</assert>
            <assert test="count(entryRelationship[observation/code/@code='6050'])&lt;=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation должен иметь не более 1 элемента entryRelationship[observation/code/@code='6050'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation[code/@code='1']">
            <assert test="count(entryRelationship[@typeCode='CAUS'])&lt;=1">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation должен иметь не более 1 элемента entryRelationship[@typeCode='CAUS'].</assert>
            <assert test="count(entryRelationship[@typeCode='REFR'])&lt;=1">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation должен иметь не более 1 элемента entryRelationship[@typeCode='REFR'].</assert>
            <assert test="count(entryRelationship[@typeCode='SUBJ'])&lt;=1">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation должен иметь не более 1 элемента entryRelationship[@typeCode='SUBJ'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation[code/@code!='1']">
            <report test="entryRelationship[@typeCode='CAUS']">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation не должен иметь элемент entryRelationship[@typeCode='CAUS'].</report>
            <report test="entryRelationship[@typeCode='REFR']">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation не должен иметь элемент entryRelationship[@typeCode='REFR'].</report>
            <report test="entryRelationship[@typeCode='SUBJ']">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation не должен иметь элемент entryRelationship[@typeCode='SUBJ'].</report>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='CAUS']">
            <assert test="@inversionInd='true'">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='CAUS'] должен иметь значение атрибута @inversionInd равное 'true'.</assert>
            <assert test="count(act)=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='CAUS'] должен иметь 1 элемент act.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='CAUS']/act/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1005','1.2.643.5.1.13.2.1.1.641','1.2.643.5.1.13.2.1.1.718']">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='CAUS']/act должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1005', '1.2.643.5.1.13.2.1.1.641' или '1.2.643.5.1.13.2.1.1.718'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='REFR']">
            <assert test="@inversionInd='false'">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='REFR'] должен иметь значение атрибута @inversionInd равное 'false'.</assert>
            <assert test="count(act)=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='REFR'] должен иметь 1 элемент act.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='REFR']/act/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1036','1.2.643.5.1.13.2.1.1.105']">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='REFR']/act должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1036' или '1.2.643.5.1.13.2.1.1.105'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='SUBJ']">
            <assert test="@inversionInd='true'">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='SUBJ'] должен иметь значение атрибута @inversionInd равное 'true'.</assert>
            <assert test="count(act)=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='SUBJ'] должен иметь 1 элемент act.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='SUBJ']/act/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1049','1.2.643.5.1.13.2.1.1.586']">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship[@typeCode='SUBJ']/act должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1049' или '1.2.643.5.1.13.2.1.1.586'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6047']">
            <assert test="count(value)=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6047'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation/code[@code='6047']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6047']/value">
            <assert test="@xsi:type='CD'">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6047']/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.547']">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6047']/value должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.547'.</assert>
            <report test="@nullFlavor">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6047']/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6048']">
            <assert test="count(value)=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6048'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation/code[@code='6048']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6048']/value">
            <assert test="@xsi:type='CD'">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6048']/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.547']">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6048']/value должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.547'.</assert>
            <report test="@nullFlavor">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6048']/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6049']">
            <assert test="count(value)=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6049'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation/code[@code='6049']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6049']/value">
            <assert test="@xsi:type='CD'">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6049']/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.547']">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6049']/value должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.547'.</assert>
            <report test="@nullFlavor">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6049']/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6050']">
            <assert test="count(value)=1">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6050'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation/code[@code='6050']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6050']/value">
            <assert test="@xsi:type='CD'">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6050']/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.546']">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6050']/value должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.546'.</assert>
            <report test="@nullFlavor">У3-9. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DGN']/entry/observation[code/@code='838']/entryRelationship/observation/entryRelationship/observation[code/@code='6050']/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <!-- У3-10 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']">
            <assert test="count(entry[observation/effectiveTime])=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS'] должен иметь 1 элемент entry[observation/effectiveTime].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]">
            <assert test="count(effectiveTime)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime] должен иметь 1 элемент effectiveTime.</assert>
            <assert test="count(performer)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime] должен иметь 1 элемент performer.</assert>
            <assert test="count(reference)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime] должен иметь 1 элемент reference.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/code">
            <assert test="@nullFlavor='NI'">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/code должен иметь значение атрибута @nullFlavor равное 'NI'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation/effectiveTime">
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer">
            <assert test="count(modeCode)&lt;=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer должен иметь не более 1 элемента modeCode.</assert>
            <assert test="count(assignedEntity)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer должен иметь 1 элемент assignedEntity.</assert>
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/modeCode">
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/modeCode не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity">
            <assert test="count(id[@root!='1.2.643.100.3'])&lt;=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь не более 1 элемента id[@root!='1.2.643.100.3'].</assert>
            <assert test="count(id[@root='1.2.643.100.3'])&lt;=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь не более 1 элемента id[@root='1.2.643.100.3'].</assert>
            <assert test="count(code)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь 1 элемент code.</assert>
            <assert test="count(addr)&lt;=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь не более 1 элемента addr.</assert>
            <assert test="count(assignedPerson)&lt;=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь не более 1 элемента assignedPerson.</assert>
            <assert test="count(representedOrganization)&lt;=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity должен иметь не более 1 элемента representedOrganization.</assert>
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/id[@root!='1.2.643.100.3']">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.70$')">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/id[@root!='1.2.643.100.3'] должен иметь синтаксически корректное значение атрибута @root, сформированное по правилу формирования идентификаторов персонала, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.70".</assert>
            <assert test="@extension!=''">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/id[@root!='1.2.643.100.3'] должен иметь не пустое значение атрибута @extension.</assert>
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/id[@root!='1.2.643.100.3'] не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/id[@root='1.2.643.100.3']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1002','1.2.643.5.1.13.2.1.1.733']">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/code должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1002' или '1.2.643.5.1.13.2.1.1.733'.</assert>
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/code не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/addr">
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/addr не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson">
            <assert test="count(name)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson должен иметь 1 элемент name.</assert>
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson/name">
            <assert test="count(family)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson/name должен иметь 1 элемент family.</assert>
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/assignedPerson/name не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization">
            <assert test="@classCode='ORG'">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization должен иметь значение атрибута @classCode равное 'ORG'.</assert>
            <assert test="count(id)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization должен иметь 1 элемент id.</assert>
            <assert test="count(name)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization должен иметь 1 элемент name.</assert>
            <assert test="count(addr)&lt;=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization должен иметь не более 1 элемента addr.</assert>
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization/id">
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization/id не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization/addr">
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/performer/assignedEntity/representedOrganization/addr не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference">
            <assert test="@typeCode='REFR'">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference должен иметь значение атрибута @typeCode равное 'REFR'.</assert>
            <assert test="count(externalDocument)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference должен иметь 1 элемент externalDocument.</assert>
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference/externalDocument">
            <assert test="@classCode='DOCCLIN'">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference/externalDocument должен иметь значение атрибута @classCode равное 'DOCCLIN'.</assert>
            <assert test="@moodCode='EVN'">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference/externalDocument должен иметь значение атрибута @moodCode равное 'EVN'.</assert>
            <assert test="count(id)=1">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference/externalDocument должен иметь 1 элемент id.</assert>
            <report test="@nullFlavor">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference/externalDocument не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference/externalDocument/id[1][not(@nullFlavor)]">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.51$')">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference/externalDocument/id[1] должен иметь синтаксически корректное значение атрибута @root, сформированное по правилу формирования идентификаторов документов, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.51".</assert>
            <assert test="@extension!=''">У3-10. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[effectiveTime]/reference/externalDocument/id[1] должен иметь не пустое значение атрибута @extension.</assert>
        </rule>
    </pattern>
    <!-- У3-11 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']">
            <assert test="count(entry[observation/code/@code='806'])=1">У3-11. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS'] должен иметь 1 элемент entry[observation/code/@code='806'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[code/@code='806']">
            <assert test="count(value)=1">У3-11. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[code/@code='806'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation/code[@code='806']">
            ...
            <report test="@nullFlavor">У3-11. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation/code[@code='806'] не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[code/@code='806']/value[not(@nullFlavor)]">
            <assert test="@xsi:type='ST'">У3-11. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESCONS']/entry/observation[code/@code='806']/value должен иметь значение атрибута @xsi:type равное 'ST'.</assert>
        </rule>
    </pattern>
    <!-- У3-12 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']">
            <assert test="count(entry[observation/effectiveTime])=1">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM'] должен иметь 1 элемент entry[observation/effectiveTime].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]">
            <assert test="count(effectiveTime)=1">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime] должен иметь 1 элемент effectiveTime.</assert>
            <assert test="count(reference)=1">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime] должен иметь 1 элемент reference.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.780']">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/code должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.780'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation/effectiveTime">
            <report test="@nullFlavor">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference">
            <assert test="@typeCode='REFR'">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference должен иметь значение атрибута @typeCode равное 'REFR'.</assert>
            <assert test="count(externalDocument)=1">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference должен иметь 1 элемент externalDocument.</assert>
            <report test="@nullFlavor">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference/externalDocument">
            <assert test="@classCode='DOCCLIN'">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference/externalDocument должен иметь значение атрибута @classCode равное 'DOCCLIN'.</assert>
            <assert test="@moodCode='EVN'">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference/externalDocument должен иметь значение атрибута @moodCode равное 'EVN'.</assert>
            <assert test="count(id)=1">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference/externalDocument должен иметь 1 элемент id.</assert>
            <report test="@nullFlavor">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference/externalDocument не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference/externalDocument/id[1][not(@nullFlavor)]">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.51$')">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference/externalDocument/id[1] должен иметь синтаксически корректное значение атрибута @root, сформированное по правилу формирования идентификаторов документов, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.51".</assert>
            <assert test="@extension!=''">У3-12. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[effectiveTime]/reference/externalDocument/id[1] должен иметь не пустое значение атрибута @extension.</assert>
        </rule>
    </pattern>
    <!-- У3-13 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']">
            <assert test="count(entry[observation/code/@code='6030'])=1">У3-13. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM'] должен иметь 1 элемент entry[observation/code/@code='6030'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[code/@code='6030']">
            <assert test="count(value)=1">У3-13. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[code/@code='6030'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation/code[@code='6030']">
            ...
            <report test="@nullFlavor">У3-13. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation/code[@code='6030'] не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[code/@code='6030']/value[not(@nullFlavor)]">
            <assert test="@xsi:type='ST'">У3-13. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='CONSILIUM']/entry/observation[code/@code='6030']/value должен иметь значение атрибута @xsi:type равное 'ST'.</assert>
        </rule>
    </pattern>
    <!-- У3-14 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']">
            <assert test="count(entry[observation/effectiveTime])=1">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB'] должен иметь 1 элемент entry[observation/effectiveTime].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]">
            <assert test="count(effectiveTime)=1">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime] должен иметь 1 элемент effectiveTime.</assert>
            <assert test="count(reference)=1">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime] должен иметь 1 элемент reference.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/code">
            <assert test="count(originalText)=1">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/code должен иметь 1 элемент originalText.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/code/originalText[not(@nullFlavor)]">
            <assert test=".!=''">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/code/originalText должен иметь не пустое значение.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation/effectiveTime">
            <report test="@nullFlavor">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference">
            <assert test="@typeCode='REFR'">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference должен иметь значение атрибута @typeCode равное 'REFR'.</assert>
            <assert test="count(externalDocument)=1">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference должен иметь 1 элемент externalDocument.</assert>
            <report test="@nullFlavor">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference/externalDocument">
            <assert test="@classCode='DOCCLIN'">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference/externalDocument должен иметь значение атрибута @classCode равное 'DOCCLIN'.</assert>
            <assert test="@moodCode='EVN'">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference/externalDocument должен иметь значение атрибута @moodCode равное 'EVN'.</assert>
            <assert test="count(id)=1">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference/externalDocument должен иметь 1 элемент id.</assert>
            <report test="@nullFlavor">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference/externalDocument не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference/externalDocument/id[1][not(@nullFlavor)]">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.51$')">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference/externalDocument/id[1] должен иметь синтаксически корректное значение атрибута @root, сформированное по правилу формирования идентификаторов документов, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.51".</assert>
            <assert test="@extension!=''">У3-14. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[effectiveTime]/reference/externalDocument/id[1] должен иметь не пустое значение атрибута @extension.</assert>
        </rule>
    </pattern>
    <!-- У3-15 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']">
            <assert test="count(entry[observation/code/@code='837'])&lt;=1">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB'] должен иметь не более 1 элемента entry[observation/code/@code='837'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[code/@code='837']">
            <assert test="count(value)=1">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[code/@code='837'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation/code[@code='837']">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.166','1.2.643.5.1.13.2.1.1.1504.41','1.2.643.5.1.13.13.11.1380']">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation/code[@code='837'] должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41' или '1.2.643.5.1.13.13.11.1380'.</assert>
            <report test="@nullFlavor">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation/code[@code='837'] не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[code/@code='837']/value[not(@nullFlavor)]">
            <assert test="@xsi:type='ST'">У3-15. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESLAB']/entry/observation[code/@code='837']/value должен иметь значение атрибута @xsi:type равное 'ST'.</assert>
        </rule>
    </pattern>
    <!-- У3-16 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']">
            <assert test="count(entry[observation/effectiveTime])=1">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR'] должен иметь 1 элемент entry[observation/effectiveTime].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]">
            <assert test="count(effectiveTime)=1">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime] должен иметь 1 элемент effectiveTime.</assert>
            <assert test="count(reference)=1">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime] должен иметь 1 элемент reference.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1471']">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/code должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1471'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/code/originalText[not(@nullFlavor)]">
            <assert test=".!=''">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/code/originalText должен иметь не пустое значение.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation/effectiveTime">
            <report test="@nullFlavor">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference">
            <assert test="@typeCode='REFR'">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference должен иметь значение атрибута @typeCode равное 'REFR'.</assert>
            <assert test="count(externalDocument)=1">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference должен иметь 1 элемент externalDocument.</assert>
            <report test="@nullFlavor">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference/externalDocument">
            <assert test="@classCode='DOCCLIN'">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference/externalDocument должен иметь значение атрибута @classCode равное 'DOCCLIN'.</assert>
            <assert test="@moodCode='EVN'">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference/externalDocument должен иметь значение атрибута @moodCode равное 'EVN'.</assert>
            <assert test="count(id)=1">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference/externalDocument должен иметь 1 элемент id.</assert>
            <report test="@nullFlavor">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference/externalDocument не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference/externalDocument/id[1][not(@nullFlavor)]">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.51$')">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference/externalDocument/id[1] должен иметь синтаксически корректное значение атрибута @root, сформированное по правилу формирования идентификаторов документов, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.51".</assert>
            <assert test="@extension!=''">У3-16. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[effectiveTime]/reference/externalDocument/id[1] должен иметь не пустое значение атрибута @extension.</assert>
        </rule>
    </pattern>
    <!-- У3-17 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']">
            <assert test="count(entry[observation/code/@code='1806'])=1">У3-17. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR'] должен иметь 1 элемент entry[observation/code/@code='1806'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[code/@code='1806']">
            <assert test="count(value)=1">У3-17. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[code/@code='1806'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation/code[@code='1806']">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.166','1.2.643.5.1.13.2.1.1.1504.41','1.2.643.5.1.13.13.11.1380']">У3-17. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation/code[@code='1806'] должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41' или '1.2.643.5.1.13.13.11.1380'.</assert>
            <report test="@nullFlavor">У3-17. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation/code[@code='1806'] не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[code/@code='1806']/value[not(@nullFlavor)]">
            <assert test="@xsi:type='ST'">У3-17. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='RESINSTR']/entry/observation[code/@code='1806']/value должен иметь значение атрибута @xsi:type равное 'ST'.</assert>
        </rule>
    </pattern>
    <!-- У3-18 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']">
            <assert test="count(entry[observation/effectiveTime])=1">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT'] должен иметь 1 элемент entry[observation/effectiveTime].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]">
            <assert test="count(effectiveTime)=1">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime] должен иметь 1 элемент effectiveTime.</assert>
            <assert test="count(reference)=1">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime] должен иметь 1 элемент reference.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/code">
            <assert test="@nullFlavor='NI'">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/code должен иметь значение атрибута @nullFlavor равное 'NI'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation/effectiveTime">
            <report test="@nullFlavor">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference">
            <assert test="@typeCode='REFR'">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference должен иметь значение атрибута @typeCode равное 'REFR'.</assert>
            <assert test="count(externalDocument)=1">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference должен иметь 1 элемент externalDocument.</assert>
            <report test="@nullFlavor">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference/externalDocument">
            <assert test="@classCode='DOCCLIN'">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference/externalDocument должен иметь значение атрибута @classCode равное 'DOCCLIN'.</assert>
            <assert test="@moodCode='EVN'">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference/externalDocument должен иметь значение атрибута @moodCode равное 'EVN'.</assert>
            <assert test="count(id)=1">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference/externalDocument должен иметь 1 элемент id.</assert>
            <report test="@nullFlavor">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference/externalDocument не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference/externalDocument/id[1][not(@nullFlavor)]">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.51$')">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference/externalDocument/id[1] должен иметь синтаксически корректное значение атрибута @root, сформированное по правилу формирования идентификаторов документов, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.51".</assert>
            <assert test="@extension!=''">У3-18. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[effectiveTime]/reference/externalDocument/id[1] должен иметь не пустое значение атрибута @extension.</assert>
        </rule>
    </pattern>
    <!-- У3-19 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']">
            <assert test="count(entry[observation/code/@code='837'])=1">У3-19. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT'] должен иметь 1 элемент entry[observation/code/@code='837'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[code/@code='837']">
            <assert test="count(value)=1">У3-19. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[code/@code='837'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation/code[@code='837']">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.166','1.2.643.5.1.13.2.1.1.1504.41','1.2.643.5.1.13.13.11.1380']">У3-19. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation/code[@code='837'] должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41' или '1.2.643.5.1.13.13.11.1380'.</assert>
            <report test="@nullFlavor">У3-19. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation/code[@code='837'] не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[code/@code='837']/value[not(@nullFlavor)]">
            <assert test="@xsi:type='ST'">У3-19. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PROC']/component/section[code/@code='GISTRESULT']/entry/observation[code/@code='837']/value должен иметь значение атрибута @xsi:type равное 'ST'.</assert>
        </rule>
    </pattern>
    <!-- У3-20 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']">
            <assert test="count(entry[act])=1">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR'] должен иметь 1 элемент entry[act].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act">
            <assert test="count(text)&lt;=1">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act должен иметь не более 1 элемента text.</assert>
            <assert test="count(effectiveTime)&lt;=1">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act должен иметь не более 1 элемента effectiveTime.</assert>
            <assert test="count(reference)=1">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act должен иметь 1 элемент reference.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1522','1.2.643.5.1.13.2.1.1.646','1.2.643.5.1.13.13.11.1115','1.2.643.5.1.13.13.99.2.195']">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/code должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1522', '1.2.643.5.1.13.2.1.1.646', '1.2.643.5.1.13.13.11.1115' или '1.2.643.5.1.13.13.99.2.195'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/effectiveTime">
            <report test="@nullFlavor">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference">
            <assert test="@typeCode='REFR'">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference должен иметь значение атрибута @typeCode равное 'REFR'.</assert>
            <assert test="count(externalDocument)=1">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference должен иметь 1 элемент externalDocument.</assert>
            <report test="@nullFlavor">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference/externalDocument">
            <assert test="@classCode='DOCCLIN'">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference/externalDocument должен иметь значение атрибута @classCode равное 'DOCCLIN'.</assert>
            <assert test="@moodCode='EVN'">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference/externalDocument должен иметь значение атрибута @moodCode равное 'EVN'.</assert>
            <assert test="count(id)=1">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference/externalDocument должен иметь 1 элемент id.</assert>
            <report test="@nullFlavor">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference/externalDocument не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference/externalDocument/id[1][not(@nullFlavor)]">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.51$')">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference/externalDocument/id[1] должен иметь синтаксически корректное значение атрибута @root, сформированное по правилу формирования идентификаторов документов, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.51".</assert>
            <assert test="@extension!=''">У3-20. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SUR']/entry/act/reference/externalDocument/id[1] должен иметь не пустое значение атрибута @extension.</assert>
        </rule>
    </pattern>
    <!-- У3-21 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']">
            <assert test="count(entry[observation])>=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR'] должен иметь не менее 1 элемента entry[observation].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation">
            <assert test="count(text)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation должен иметь 1 элемент text.</assert>
            <assert test="count(statusCode)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation должен иметь 1 элемент statusCode.</assert>
            <assert test="count(effectiveTime)&lt;=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation должен иметь не более 1 элемента effectiveTime.</assert>
            <assert test="count(value)&lt;=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation должен иметь не более 1 элемента value.</assert>
            <assert test="count(performer)>=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation должен иметь не менее 1 элемента performer.</assert>
            <assert test="count(entryRelationship[substanceAdministration])&lt;=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation должен иметь не более 1 элемента entryRelationship[substanceAdministration].</assert>
            <assert test="count(entryRelationship[observation/code/@code='12178'])&lt;=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation должен иметь не более 1 элемента entryRelationship[observation/code/@code='12178'].</assert>
            <assert test="count(entryRelationship[observation/code/@code='12179'])&lt;=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation должен иметь не более 1 элемента entryRelationship[observation/code/@code='12179'].</assert>
            <assert test="count(entryRelationship[observation/code/@code='12180'])=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation должен иметь 1 элемент entryRelationship[observation/code/@code='12180'].</assert>
            <assert test="count(entryRelationship[observation/code/@code='12181'])&lt;=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation должен иметь не более 1 элемента entryRelationship[observation/code/@code='12181'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1070','1.2.643.5.1.13.2.1.1.473']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/code должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1070' или '1.2.643.5.1.13.2.1.1.473'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/effectiveTime">
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/value">
            <assert test="@xsi:type='CD'">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.812']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/value должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.812'.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer">
            <assert test="count(modeCode)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer должен иметь 1 элемент modeCode.</assert>
            <assert test="count(assignedEntity)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer должен иметь 1 элемент assignedEntity.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/modeCode">
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/modeCode не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>

    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity">
            <assert test="count(id)&lt;=2">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity должен иметь не более 2 элементов id.</assert>
            <assert test="count(code)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity должен иметь 1 элемент code.</assert>
            <assert test="count(addr)&lt;=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity должен иметь не более 1 элемента addr.</assert>
            <assert test="count(assignedPerson)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity должен иметь 1 элемент assignedPerson.</assert>
            <assert test="count(representedOrganization)&lt;=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity должен иметь не более 1 элемента representedOrganization.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/id[1]">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.70$')">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/id[1] должен иметь синтаксически корректное значение атрибута @root, сформированное по правилу формирования идентификаторов персонала, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.70".</assert>
            <assert test="@extension!=''">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/id[1] должен иметь не пустое значение атрибута @extension.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/id[1] не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/id[2]">
            <assert test="@extension!=''">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/id[2] должен иметь не пустое значение атрибута @extension.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/id[2] не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1002','1.2.643.5.1.13.2.1.1.733']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/code должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1002' или '1.2.643.5.1.13.2.1.1.733'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/addr">
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/addr не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/assignedPerson">
            <assert test="count(name)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/assignedPerson должен иметь 1 элемент name.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/assignedPerson не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/assignedPerson/name">
            <assert test="count(family)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/assignedPerson/name должен иметь 1 элемент family.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/assignedPerson/name не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/representedOrganization">
            <assert test="@classCode='ORG'">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/representedOrganization должен иметь значение атрибута @classCode равное 'ORG'.</assert>
            <assert test="count(id)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/representedOrganization должен иметь 1 элемент id.</assert>
            <assert test="count(name)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/representedOrganization должен иметь 1 элемент name.</assert>
            <assert test="count(addr)&lt;=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/representedOrganization должен иметь не более 1 элемента addr.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/representedOrganization не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/representedOrganization/id">
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/representedOrganization/id не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/representedOrganization/addr">
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/performer/assignedEntity/representedOrganization/addr не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship[substanceAdministration]">
            <assert test="count(substanceAdministration)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship должен иметь 1 элемент substanceAdministration.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/substanceAdministration">
            <assert test="@moodCode='EVN'">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/substanceAdministration должен иметь значение атрибута @moodCode равное 'EVN'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/substanceAdministration/consumable/manufacturedProduct">
            <assert test="count(manufacturedLabeledDrug)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/substanceAdministration/consumable/manufacturedProduct должен иметь 1 элемент manufacturedLabeledDrug.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/substanceAdministration/consumable/manufacturedProduct/manufacturedLabeledDrug">
            <assert test="count(code)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/substanceAdministration/consumable/manufacturedProduct/manufacturedLabeledDrug должен иметь 1 элемент code.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/substanceAdministration/consumable/manufacturedProduct/manufacturedLabeledDrug не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/substanceAdministration/consumable/manufacturedProduct/manufacturedLabeledDrug/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1033']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/substanceAdministration/consumable/manufacturedProduct/manufacturedLabeledDrug/code должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1033'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12176']">
            <assert test="count(value)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12176'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12176']">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.166','1.2.643.5.1.13.2.1.1.1504.41','1.2.643.5.1.13.13.11.1380']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12176'] должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41' или '1.2.643.5.1.13.13.11.1380'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12176']/value">
            <assert test="@xsi:type='CD'">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12176']/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.449','1.2.643.5.1.13.2.1.1.139']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12176']/value должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.449' или '1.2.643.5.1.13.2.1.1.139'.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12176']/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']">
            <assert test="count(participant)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177'] должен иметь 1 элемент participant.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12177']">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.166','1.2.643.5.1.13.2.1.1.1504.41','1.2.643.5.1.13.13.11.1380']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12177'] должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41' или '1.2.643.5.1.13.13.11.1380'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant">
            <assert test="@typeCode=['DEV','CSM']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant должен иметь значение атрибута @typeCode равное 'DEV' или 'CSM'.</assert>
            <assert test="count(participantRole)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant должен иметь 1 элемент participantRole.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole">
            <assert test="@classCode='ROL'">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole должен иметь значение атрибута @classCode равное 'ROL'.</assert>
            <assert test="count(id)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole должен иметь 1 элемент id.</assert>
            <assert test="count(playingDevice)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole должен иметь 1 элемент playingDevice.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole/id[not(@nullFlavor)]">
            <assert test="matches(@root,'^[0-2](\.([1-9][0-9]*|0))+\.100([.]([1-9][0-9]*|0))+\.67$')">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole/id должен иметь синтаксически корректное значение атрибута @root, т.е. "OID_медицинской_организации.100.НомерМИС.НомерЭкзМИС.67".</assert>
            <assert test="@extension!=''">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole/id должен иметь не пустое значение атрибута @extension.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole/playingDevice">
            <assert test="count(manufacturerModelName)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole/playingDevice должен иметь 1 элемент manufacturerModelName.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole/playingDevice не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole/playingDevice/manufacturerModelName">
            <assert test=".!=''">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole/playingDevice/manufacturerModelName должен иметь не пустое значение.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12177']/participant/participantRole/playingDevice/manufacturerModelName не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12178']">
            <assert test="count(value)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12178'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12178']">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.166','1.2.643.5.1.13.2.1.1.1504.41','1.2.643.5.1.13.13.11.1380']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12178'] должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41' или '1.2.643.5.1.13.13.11.1380'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12178']/value">
            <assert test="@xsi:type='ST'">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12178']/value должен иметь значение атрибута @xsi:type равное 'ST'.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12178']/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12179']">
            <assert test="count(value)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12179'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12179']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12179']/value">
            <assert test="@xsi:type='ST'">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12179']/value должен иметь значение атрибута @xsi:type равное 'ST'.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12179']/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12180']">
            <assert test="count(value)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12180'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12180']">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.166','1.2.643.5.1.13.2.1.1.1504.41','1.2.643.5.1.13.13.11.1380']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12180'] должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41' или '1.2.643.5.1.13.13.11.1380'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12180']/value">
            <assert test="@xsi:type='CD'">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12180']/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1503']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12180']/value должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1503'.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12180']/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12181']">
            <assert test="count(value)=1">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12181'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12181']">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.166','1.2.643.5.1.13.2.1.1.1504.41','1.2.643.5.1.13.13.11.1380']">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation/code[@code='12181'] должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41' или '1.2.643.5.1.13.13.11.1380'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12181']/value">
            <assert test="@xsi:type='ST'">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12181']/value должен иметь значение атрибута @xsi:type равное 'ST'.</assert>
            <report test="@nullFlavor">У3-21. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='PLANSUR']/entry/observation/entryRelationship/observation[code/@code='12181']/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <!-- У3-22 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation">
            <assert test="count(text)&lt;=1">У3-22. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation должен иметь не более 1 элемента text.</assert>
            <assert test="count(effectiveTime)=1">У3-22. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation должен иметь 1 элемент effectiveTime.</assert>
            <assert test="count(value)=1">У3-22. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation/code">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1514']">У3-22. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation/code должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1514'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation/effectiveTime">
            <report test="@nullFlavor">У3-22. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation/value">
            <assert test="@xsi:type='PQ'">У3-22. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation/value должен иметь значение атрибута @xsi:type равное 'PQ'.</assert>
            <assert test="count(translation)=1">У3-22. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation/value должен иметь 1 элемент translation.</assert>
            <report test="@nullFlavor">У3-22. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='SCORES']/entry/observation/value не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <!-- У3-23 -->
    <pattern>
...
<!-- [Core07_17]Модуль проверки элементов code (//code) -->

<!-- Альтернативный вариант: допускается @nullFlavor для code в секциях PATOBJ, RESCONS, GISTRESULT, не проверяется в секции RESLAB -->
...
<!-- Список изменений -->
<!-- 04.04.2023 - v.1.0.0: Модуль разработан -->

    <!-- Core07-1 -->
    <pattern>
        <rule context="//code[not(parent::criterion)][not(ancestor::section[code/@code=['PATOBJ','RESCONS','GISTRESULT','RESLAB']])]">
    ...
    <pattern>
        <rule context="//code[(ancestor::section[code/@code=['PATOBJ','RESCONS','GISTRESULT']])][not(@nullFlavor)]">
            <assert test="@codeSystem!=''">Core07-1. Элемент //code должен иметь не пустое значение атрибута @codeSystem.</assert>
            <assert test="@codeSystemName!=''">Core07-1. Элемент //code должен иметь не пустое значение атрибута @codeSystemName.</assert>
            <assert test="@code!=''">Core07-1. Элемент //code должен иметь не пустое значение атрибута @code.</assert>
            <assert test="@codeSystemVersion!=''">Core07-1. //code должен иметь не пустое значение атрибута @codeSystemVersion.</assert>
...
<!-- [Core08_17]Модуль проверки информации о сотруднике МО или о передвижном подразделении (//assignedEntity) -->

<!-- Альтернативный вариант: не проверять для секций 'PATOBJ', 'RESCONS', 'PLANSUR' -->
...
<!-- 10.04.2023 - v.1.0.0: Модуль разработан -->
    ...
    <!-- Core08-1 -->
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][not(id[1]/@nullFlavor)]">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])]/id[1][not(@nullFlavor)]">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][not(id[1]/@nullFlavor)]/id[2]">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][not(id[1]/@nullFlavor)]/code">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][not(id[1]/@nullFlavor)]/addr">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][not(id[1]/@nullFlavor)]/assignedPerson">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][not(id[1]/@nullFlavor)]/assignedPerson/name">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][not(id[1]/@nullFlavor)]/representedOrganization">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][not(id[1]/@nullFlavor)]/representedOrganization/id">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][not(id[1]/@nullFlavor)]/representedOrganization/addr">
    ...
    <!-- Core08-2 -->
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][id[1]/@nullFlavor='NI']">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][id[1]/@nullFlavor='NI']/representedOrganization">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][id[1]/@nullFlavor='NI']/representedOrganization/id">
    ...
    <pattern>
        <rule context="//assignedEntity[not(ancestor::section[code/@code=['PATOBJ','RESCONS','PLANSUR']])][id[1]/@nullFlavor='NI']/representedOrganization/addr">
...
<!-- 01.12.2022 - v.1.0.0: Модуль разработан -->
    ...
    <pattern>
        <rule context="//entryRelationship[not(observation/code/@code='808')][not(act)]">
    ...
    <pattern>
        <rule context="//entryRelationship[not(observation/code/@code='808')][act]">
            <assert test="@typeCode=['CAUS','REFR','SUBJ']">Core10-1. Элемент //entryRelationship должен иметь значение атрибута @typeCode равное 'CAUS','REFR','SUBJ'.</assert>
            <report test="@nullFlavor">Core10-1. Элемент //entryRelationship не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
...
<!-- [Core11_12]Модуль проверки наполнения секции (//observation/value[@xsi:type=['CD','ST','BL','PQ','TS','INT']], //translation, //text, //substanceAdministration, //precondition, //interpretationCode, //statusCode, //referenceRange, //modeCode) -->

<!-- Альтернативный вариант: value[@xsi:type=['CD','ST','BL','PQ','TS','INT']] может иметь @nullFlavor, в substanceAdministration не проверяется @moodCode, manufacturedProduct в секцях SUR, PLANSUR должен иметь 1 manufacturedLabeledDrug -->
...
<!-- 10.04.2023 - v.1.0.0: Модуль разработан -->
    ...
    <pattern>
        <rule context="//substanceAdministration/consumable/manufacturedProduct[not(ancestor::component[section/code/@code=['SUR','PLANSUR']])]">
...
<!-- [Main08_1]Модуль проверки информации о пациенте (ClinicalDocument/documentationOf) -->
...
-->
<!-- 13.10.2022 - v.2.0.0: Изменение принципа построения модуля - запрет @nullFlavor в элементах [0..1] и R[1..1] -->
