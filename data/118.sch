<!-- Схематрон для СЭМД "Документ, содержащий сведения медицинского свидетельства о рождении в бумажной форме" (Редакция 4) -->
...
<ns prefix="address" uri="urn:hl7-ru:address"/>
	...
	<pattern>
		<rule context="ClinicalDocument/participant[@typeCode='IRCP']/associatedEntity/id[not(@nullFlavor)]">
            ...
            <assert test="@extension!=''">У1-49. Элемент ClinicalDocument/participant[@typeCode='IRCP']/associatedEntity/id должен иметь не пустое значение атрибута @extension.</assert>
        </rule>
    </pattern>
    <!-- У1-50 -->
    <pattern>
	...
	<pattern>
        ...
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code[@code='4120']]/value">
            <assert test="matches(.,'[0-9]{2}$')">Согласно НПА для сведений о бумажном медицинском свидетельстве о рождении количество знаков в серии должно состоять из двух разрядов.</assert>
	...
	<pattern>
        ...
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code[@code='4121']]/value">
            <assert test="matches(.,'^[2]{1}[0-9]{9}$')">Согласно НПА для сведений о бумажном медицинском свидетельстве о рождении требуется указывать первую цифру номера документа равную '2', а количество знаков в номере должно состоять из десяти разрядов.</assert>
	...
	<pattern>
        ...
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='MOTHINFO']/subject/relatedSubject[f103:id[not(@nullFlavor)]]">
            <assert test="f103:id/@extension">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='MOTHINFO']/subject/relatedSubject/f103:id должен иметь атрибут @extension.</assert>
