<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        <rule context="ClinicalDocument/templateId">
            <report test="@nullFlavor">Элемент ClinicalDocument/templateId не должен иметь атрибут
                @nullFlavor</report>
            <assert test="@root = '1.2.643.5.1.13.13.15.61.2'">Элемент templateId обязан содержать
                один атрибут @root со значением "1.2.643.5.1.13.13.15.61.2"</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/code">
            <report test="@nullFlavor">Элемент ClinicalDocument/code не должен иметь атрибут
                @nullFlavor</report>
            <assert test="@code = '61'">Элемент code обязан содержать один атрибут @code со
                значением "61"</assert>
    ...
    <pattern>
        <rule context="ClinicalDocument/code/translation">
            ...
            <assert test="@code = '195'">Элемент translation обязан содержать один
                атрибут @code со значением "195"</assert>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            ...
            <assert test="count(component[section/code/@code = 'DGN']) = [0, 1]">Элемент
                structuredBody МОЖЕТ содержать не более одного [0..1] элемента component
                (ClinicalDocument/component/structuredBody) </assert>
            <assert test="count(component[section/code/@code = 'RESREHABILITATION']) = [0, 1]"
    ...
    <pattern>
        <rule
            ...
            <assert test="count(title) = 1">Элемент section ОБЯЗАН содержать один [1..1] элемент
                title
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '8088']) = 1">Элемент section ОБЯЗАН
                содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '11015']) = 1">Элемент section ОБЯЗАН
                содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '12159']) = [0, 1]">Элемент section
                МОЖЕТ содержать не более одного [0..1] элемента entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '11016']) = [0, 1]">Элемент section
                МОЖЕТ содержать не более одного [0..1] элемента entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '11018']) = [0, 1]">Элемент section
                МОЖЕТ содержать не более одного [0..1] элемента entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '11019']) = 1">Элемент section ОБЯЗАН
                содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section) </assert>
            <assert test="count(entry[observation/code/@code = '11020']) = [0, 1]">Элемент section
                МОЖЕТ содержать не более одного [0..1] элемента entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '8088']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '8088']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='8088']/observation) </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '8088']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '8088'">Элемент code обязан содержать один атрибут @code со
                значением "8088"</assert>
            <assert
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '8088']/observation/text">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '8088']/observation/value">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="@xsi:type = 'CD'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.723'">Элемент value обязан содержать
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11015']/observation) </assert>
            <assert test="count(value) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11015']/observation) </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11015'">Элемент code обязан содержать один атрибут @code со
                значением "11015"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/value">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(id) = 1">Элемент assignedEntity ДОЛЖЕН содержать один [1..1] элемент
                id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11015']/observation/performer/assignedEntity) </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/id">
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(id[1]) = 1">Элемент representedOrganization ДОЛЖЕН содержать один
                [1..1] элемент id
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11015']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(name) = 1">Элемент representedOrganization ОБЯЗАН содержать один
                [1..1] элемент name
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11015']/observation/performer/assignedEntity/representedOrganization) </assert>
            <assert test="count(addr) = 1">Элемент representedOrganization ДОЛЖЕН содержать один
                [1..1] элемент addr
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11015']/observation/performer/assignedEntity/representedOrganization)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization/id[1][not(@nullFlavor)]">
            <assert test="@root != ''">Элемент id должен содержать один атрибут @root с не пустым
                значением</assert>
            <assert test="count(@extension != '') = [0, 1]">Элемент id должен содержать один атрибут
                @extension с не пустым значением</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization/id[1][@nullFlavor]">
            <report test="@root">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @root</report>
            <report test="@extension">Атрибут nullFlavor не должен быть представлен совместно с
                атрибутом @extension</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization/name">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization/addr[not(@nullFlavor)]">
            <assert test="count(streetAddressLine) = 1">Элемент addr ОБЯЗАН содержать один [1..1]
                элемент streetAddressLine
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11015']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(address:stateCode) = 1">Элемент addr ОБЯЗАН содержать один [1..1]
                элемент address:stateCode
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11015']/observation/performer/assignedEntity/representedOrganization/addr) </assert>
            <assert test="count(postalCode) = 1">Элемент addr ДОЛЖЕН содержать один [1..1] элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization/addr/streetAddressLine">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization/addr/address:stateCode">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization/addr/postalCode[not(@nullFlavor)]">
            <assert test=". != ''">Элемент postalCode должен содержать не пустое текстовое
                наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address[not(@nullFlavor)]">
            <assert test="count(fias:AOGUID) = 1">Элемент fias:Address ОБЯЗАН содержать один [1..1]
                элемент fias:AOGUID
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11015']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address) </assert>
            <assert test="count(fias:HOUSEGUID) = 1">Элемент fias:Address ДОЛЖЕН содержать один
                [1..1] элемент fias:HOUSEGUID
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:AOGUID">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11015']/observation/performer/assignedEntity/representedOrganization/addr/fias:Address/fias:HOUSEGUID[not(@nullFlavor)]">
            <assert test=". != ''">Элемент fias:HOUSEGUID должен содержать не пустое текстовое
                наполнение</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12159']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12159']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12159']/observation) </assert>
            <assert test="count(value) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='12159']/observation)
            </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12159']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '12159'">Элемент code обязан содержать один атрибут @code со
                значением "12159"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '12159']/observation/value">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11016']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11016']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11016']/observation) </assert>
            <assert test="count(effectiveTime) = 1">Элемент observation ОБЯЗАН содержать один [1..1]
                элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11016']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '11017']) = [0, 1]"
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11016']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11016'">Элемент code обязан содержать один атрибут @code со
                значением "11016"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11016']/observation/effectiveTime">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(low) = 1">Элемент effectiveTime ОБЯЗАН содержать один [1..1] элемент
                low
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11016']/observation/effectiveTime) </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11016']/observation/effectiveTime/low">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11016']/observation/effectiveTime/high">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11016']/observation/entryRelationship[observation/code/@code = '11017']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11016']/observation/entryRelationship[observation/code/@code = '11017']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11016']/observation/entryRelationship[observation/code/@code='11017']/observation) </assert>
            <assert test="count(effectiveTime) = 1">Элемент observation ОБЯЗАН содержать один [1..1]
                элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11016']/observation/entryRelationship[observation/code/@code='11017']/observation)
            </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11016']/observation/entryRelationship[observation/code/@code = '11017']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11017'">Элемент code обязан содержать один атрибут @code со
                значением "11017"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11016']/observation/entryRelationship[observation/code/@code = '11017']/observation/effectiveTime">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11018']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11018']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11018']/observation) </assert>
            <assert test="count(effectiveTime) = 1">Элемент observation ОБЯЗАН содержать один [1..1]
                элемент effectiveTime
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11018']/observation)
            </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11018']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11018'">Элемент code обязан содержать один атрибут @code со
                значением "11018"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11018']/observation/effectiveTime">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(low) = 1">Элемент effectiveTime ОБЯЗАН содержать один [1..1] элемент
                low
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11018']/observation/effectiveTime) </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11018']/observation/effectiveTime/low">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11018']/observation/effectiveTime/high">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11019']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11019']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11019']/observation) </assert>
            <assert test="count(value) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11019']/observation)
            </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11019']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11019'">Элемент code обязан содержать один атрибут @code со
                значением "11019"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11019']/observation/value">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11020']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11020']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11020']/observation) </assert>
            <assert test="count(value) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='DOCINFO']/section/entry[observation/code/@code='11020']/observation)
            </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11020']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '11020'">Элемент code обязан содержать один атрибут @code со
                значением "11020"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DOCINFO']/section/entry[observation/code/@code = '11020']/observation/value">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@codeSystem = '1.2.643.5.1.13.13.11.1077']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "CD"</assert>
            <assert
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'DGN']/section/entry[observation/code/@codeSystem = '1.2.643.5.1.13.13.11.1077']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "CD"</assert>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section">
            <report test="@nullFlavor">Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(code) = 1">Элемент section ОБЯЗАН содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section) </assert>
            <assert test="count(title) = 1">Элемент section ОБЯЗАН содержать один [1..1] элемент
                title
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section) </assert>
            <assert test="count(entry[observation/code/@code = '8092']) = 1">Элемент section ОБЯЗАН
                содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section) </assert>
            <assert test="count(entry[observation/code/@code = '8093']) = 1">Элемент section ОБЯЗАН
                содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section) </assert>
            <assert test="count(entry[observation/code/@code = '4055']) = 1">Элемент section ОБЯЗАН
                содержать один [1..1] элемент entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section) </assert>
            <assert test="count(entry[observation/code/@code = '8094']) >= 0">Элемент section МОЖЕТ
                содержать произвольное количество [0..*] элементов entry
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section) </assert>
            <assert test="count(component[section/code/@code = 'REHABDGN']) = [0, 1]">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/code">
            <report test="@nullFlavor">Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = 'RESREHABILITATION'">Элемент code обязан содержать один атрибут
                @code со значением "RESREHABILITATION"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.197', '1.2.643.5.1.13.2.1.1.1504.23', '1.2.643.5.1.13.13.11.1379']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.197"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/title">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8092']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8092']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/entry[observation/code/@code='8092']/observation) </assert>
            <assert test="count(value) = 1">Элемент observation ДОЛЖЕН содержать один [1..1] элемент
                value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/entry[observation/code/@code='8092']/observation)
            </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8092']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '8092'">Элемент code обязан содержать один атрибут @code со
                значением "8092"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8092']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'ST'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "ST"</assert>
            <assert test=". != ''">Элемент value должен содержать не пустое текстовое
                наполнение</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8092']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'ST'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "ST"</assert>
        </rule>
    </pattern>
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8093']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8093']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/entry[observation/code/@code='8093']/observation) </assert>
            <assert test="count(value) = 1">Элемент observation ДОЛЖЕН содержать один [1..1] элемент
                value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/entry[observation/code/@code='8093']/observation)
            </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8093']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '8093'">Элемент code обязан содержать один атрибут @code со
                значением "8093"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8093']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.11.1548'">Элемент value должен содержать
                один атрибут @codeSystem со значением "1.2.643.5.1.13.13.11.1548"</assert>
            <assert test="@codeSystemName != ''">Элемент value должен содержать один атрибут
                @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">Элемент value должен содержать один атрибут @code с не пустым
                значением</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8093']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "CD"</assert>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '4055']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '4055']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/entry[observation/code/@code='4055']/observation) </assert>
            <assert test="count(value) = 1">Элемент observation ДОЛЖЕН содержать один [1..1] элемент
                value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/entry[observation/code/@code='4055']/observation)
            </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '4055']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '4055'">Элемент code обязан содержать один атрибут @code со
                значением "4055"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '4055']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.1014'">Элемент value должен
                содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.1014"</assert>
            <assert test="@codeSystemName != ''">Элемент value должен содержать один атрибут
                @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">Элемент value должен содержать один атрибут @code с не пустым
                значением</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '4055']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "CD"</assert>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8094']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8094']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/entry[observation/code/@code='8094']/observation) </assert>
            <assert test="count(value) = 1">Элемент observation ДОЛЖЕН содержать один [1..1] элемент
                value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/entry[observation/code/@code='8094']/observation)
            </assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8094']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '8094'">Элемент code обязан содержать один атрибут @code со
                значением "8094"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8094']/observation/value[not(@nullFlavor)]">
            <assert test="@xsi:type = 'CD'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.1013'">Элемент value должен
                содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.1013"</assert>
            <assert test="@codeSystemName != ''">Элемент value должен содержать один атрибут
                @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">Элемент value должен содержать один атрибут @code с не пустым
                значением</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8094']/observation/value[@nullFlavor]">
            <assert test="@xsi:type = 'CD'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "CD"</assert>
            <report test="@code">Атрибут nullFlavor не должен быть представлен совместно с атрибутом
                @code</report>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/entry[observation/code/@code = '8094']/observation/value/originalText">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="count(code) = 1">Элемент section ОБЯЗАН содержать один [1..1] элемент code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section) </assert>
            <assert test="count(title) = 1">Элемент section ОБЯЗАН содержать один [1..1] элемент
                title
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section) </assert>
            <assert test="count(entry[observation/code/@code = '8089']) >= 1">Элемент section ОБЯЗАН
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = 'REHABDGN'">Элемент code обязан содержать один атрибут @code со
                значением "REHABDGN"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.197', '1.2.643.5.1.13.2.1.1.1504.23', '1.2.643.5.1.13.13.11.1379']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.197"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/title">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section/entry[observation/code/@code='8089']/observation) </assert>
            <assert test="count(text) = [0, 1]">Элемент observation МОЖЕТ содержать не более одного
                [0..1] элемента text
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section/entry[observation/code/@code='8089']/observation) </assert>
            <assert test="count(effectiveTime) = 1">Элемент observation ОБЯЗАН содержать один [1..1]
            ...
            <assert test="count(value) = [0, 1]">Элемент observation МОЖЕТ содержать не более одного
                [0..1] элемента value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section/entry[observation/code/@code='8089']/observation) </assert>
            <assert test="count(entryRelationship[observation/code/@code = '8090']) >= 1">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '8089'">Элемент code обязан содержать один атрибут @code со
                значением "8089"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation/text">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation/effectiveTime">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation/value">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@xsi:type = 'REAL'">Элемент value обязан содержать один атрибут @xsi:type
                со значением "REAL"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation/entryRelationship[observation/code/@code = '8090']">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation/entryRelationship[observation/code/@code = '8090']/observation">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section/entry[observation/code/@code='8089']/observation/entryRelationship[observation/code/@code='8090']/observation) </assert>
            <assert test="count(text) = [0, 1]">Элемент observation МОЖЕТ содержать не более одного
                [0..1] элемента text
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section/entry[observation/code/@code='8089']/observation/entryRelationship[observation/code/@code='8090']/observation) </assert>
            <assert test="count(value) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                ...
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section/entry[observation/code/@code='8089']/observation/entryRelationship[observation/code/@code='8090']/observation) </assert>
            <assert
                test="count(entryRelationship[observation/code/@codeSystem = '1.2.643.5.1.13.13.99.2.1091']) >= 1"
                >Элемент observation ОБЯЗАН содержать не менее одного [1..*] элемента
                entryRelationship
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section/entry[observation/code/@code='8089']/observation/entryRelationship[observation/code/@code='8090']/observation)
            </assert>
        </rule>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation/entryRelationship[observation/code/@code = '8090']/observation/code">
            <report test="@nullFlavor">Элемент
                ...
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@code = '8090'">Элемент code обязан содержать один атрибут @code со
                значением "8090"</assert>
            <assert
                test="@codeSystem = ['1.2.643.5.1.13.13.99.2.166', '1.2.643.5.1.13.2.1.1.1504.41', '1.2.643.5.1.13.13.11.1380']"
                >Элемент code обязан содержать один атрибут @codeSystem со значением
                "1.2.643.5.1.13.13.99.2.166"</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation/entryRelationship[observation/code/@code = '8090']/observation/text">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation/entryRelationship[observation/code/@code = '8090']/observation/value">
            <report test="@nullFlavor">Элемент
            ...
            <assert test="@xsi:type = 'CD'">Элемент value обязан содержать один атрибут @xsi:type со
                значением "CD"</assert>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.951'">Элемент value обязан содержать
                один атрибут @codeSystem со значением "1.2.643.5.1.13.13.99.2.951"</assert>
            <assert test="@codeSystemName != ''">Элемент value обязан содержать один атрибут
                @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">Элемент value обязан содержать один атрибут @code с не пустым
                значением</assert>
    ...
    <pattern>
        <rule
            context="ClinicalDocument/component/structuredBody/component[section/code/@code = 'RESREHABILITATION']/section/component[section/code/@code = 'REHABDGN']/section/entry[observation/code/@code = '8089']/observation/entryRelationship[observation/code/@code = '8090']/observation/value/originalText">
            <report test="@nullFlavor">Элемент
    ...
    <pattern>
        <rule
            ...
            <assert test="count(code) = 1">Элемент observation ОБЯЗАН содержать один [1..1] элемент
                code
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section/entry[observation/code/@code='8089']/observation/entryRelationship[observation/code/@code='8090']/observation/entryRelationship[observation/code/@codeSystem='1.2.643.5.1.13.13.99.2.1091']/observation) </assert>
            <assert test="count(value) = 1">Элемент observation ДОЛЖЕН содержать один [1..1] элемент
                value
                (ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section/entry[observation/code/@code='8089']/observation/entryRelationship[observation/code/@code='8090']/observation/entryRelationship[observation/code/@codeSystem='1.2.643.5.1.13.13.99.2.1091']/observation)
            </assert>
    ...
    <pattern>
        <rule
            ...
            <report test="@nullFlavor">Элемент
                ClinicalDocument/component/structuredBody/component[section/code/@code='RESREHABILITATION']/section/component[section/code/@code='REHABDGN']/section/entry[observation/code/@code='8089']/observation/entryRelationship[observation/code/@code='8090']/observation/entryRelationship[observation/code/@codeSystem='1.2.643.5.1.13.13.99.2.1091']/observation/code
                не должен иметь атрибут @nullFlavor</report>
            <assert test="@codeSystem = '1.2.643.5.1.13.13.99.2.1091'">Элемент code обязан содержать
                один атрибут @codeSystem со значением "1.2.643.5.1.13.13.99.2.1091"</assert>
            <assert test="@codeSystemName != ''">Элемент code обязан содержать один атрибут
                @codeSystemName с не пустым значением</assert>
            <assert test="@code != ''">Элемент code обязан содержать один атрибут @code с не пустым
                значением</assert>
    ...
    <pattern>
        <rule
            ...
            <assert test="@code != ''">Элемент value должен содержать один атрибут @code с не пустым
                значением</assert>
            <assert test="@codeSystem != ''">Элемент value должен содержать один атрибут @codeSystem
                с не пустым значением</assert>
            <assert test="@codeSystemVersion != ''">Элемент value должен содержать один атрибут
                @codeSystemVersion с не пустым значением</assert>
            <assert test="@codeSystemName != ''">Элемент value должен содержать один атрибут
