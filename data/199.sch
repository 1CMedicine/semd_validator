    ...
    <pattern>
        <rule context="ClinicalDocument/templateId">
            <report test="@nullFlavor">Элемент ClinicalDocument/templateId не должен иметь атрибут
                @nullFlavor</report>
            <assert test="@root = ['1.2.643.5.1.13.13.15.89.1.1','1.2.643.5.1.13.13.15.89.1.2','1.2.643.5.1.13.13.15.89.1.3']">Элемент templateId обязан содержать один атрибут root со значением '1.2.643.5.1.13.13.15.89.1.1','1.2.643.5.1.13.13.15.89.1.2','1.2.643.5.1.13.13.15.89.1.3'</assert>
        </rule>
    </pattern>
    <pattern>
