...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern>
        <rule context="ClinicalDocument/documentationOf/serviceEvent/code">
            <assert test="@code='58'">У1-18. Элемент ClinicalDocument/documentationOf/serviceEvent/code должен иметь значение атрибута @code равное '58'.</assert>
        </rule>
    </pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/templateId">
            <assert test="@root='1.2.643.5.1.13.13.14.86.9.2'">У1-3. Элемент ClinicalDocument/templateId должен иметь значение атрибута @root равное '1.2.643.5.1.13.13.14.86.9.2'.</assert>
        </rule>
    </pattern>
    <!-- У1-5 -->
    <pattern>
        <rule context="ClinicalDocument/code">
            <assert test="@code='86'">У1-5. Элемент ClinicalDocument/code должен иметь значение атрибута @code равное '86'.</assert>
        </rule>
    </pattern>
    <!-- У2-1 -->
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            <assert test="count(component[section/code/@code='RECIPE'])=1">У2-2. Элемент ClinicalDocument/component/structuredBody должен иметь 1 элемент component[section/code/@code='RECIPE'].</assert>
        </rule>
    </pattern>
    <!-- У2-3 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody">
            <assert test="count(component[section/code/@code='LINKDOCS'])&lt;=1">У2-3. Элемент ClinicalDocument/component/structuredBody должен иметь не более 1 элемента component[section/code/@code='LINKDOCS'].</assert>
        </rule>
    </pattern>
    <!-- У3-1 -->
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']">
            <assert test="count(entry[observation/code/@code='6004'])=1">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO'] должен иметь 1 элемент entry.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6004']">
            <assert test="count(value)=1">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6004'] должен иметь 1 элемент value.</assert>
            <assert test="count(effectiveTime)=1">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6004'] должен иметь 1 элемент effectiveTime.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation/code[@code='6004']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6004']/effectiveTime">
            <report test="@nullFlavor">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6004']/effectiveTime не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6004']/value">
            <assert test="@xsi:type='CD'">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6004']/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.608']">У3-2. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6004']/value должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.99.2.608'.</assert>
        </rule>
    </pattern>
    <!-- У3-3 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']">
            <assert test="count(entry[observation/code/@code='6006'])=1">У3-3. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO'] должен иметь 1 элемент entry.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6006']">
            <assert test="count(value)=1">У3-3. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6006'] должен иметь 1 элемент value.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation/code[@code='6006']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6006']/value">
            <assert test="@xsi:type='BL'">У3-3. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']/entry/observation[code/@code='6006']/value должен иметь значение атрибута @xsi:type равное 'BL'.</assert>
        </rule>
    </pattern>
    <!-- У3-4 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']">
            <assert test="count(entry)=[1,2,3]">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE'] должен иметь 1, 2 или 3 элемента entry.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry">
            <assert test="count(substanceAdministration)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry должен иметь 1 элемент substanceAdministration.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration">
            <assert test="count(effectiveTime)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration должен иметь 1 элемент effectiveTime.</assert>
            <assert test="count(routeCode)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration должен иметь 1 элемент routeCode.</assert>
            <assert test="count(entryRelationship[observation/code/@code='6011'])=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration должен иметь 1 элемент entryRelationship.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime[not(@nullFlavor)]">
            <assert test="@xsi:type='IVL_TS'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime должен иметь значение атрибута @xsi:type равное 'IVL_TS'.</assert>
            <assert test="count(width|low)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime должен иметь 1 элемент width или 1 элемент low.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime[low]">
            <assert test="count(high)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime[low] должен иметь 1 элемент high.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime/width">
            <assert test="@value!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime/width должен иметь не пустое значение атрибута @value.</assert>
            <assert test="@unit!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime/width должен иметь не пустое значение атрибута @unit.</assert>
            <assert test="count(translation)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime/width должен иметь 1 элемент translation.</assert>
            <report test="@nullFlavor">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime/width не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime/low">
            <report test="@nullFlavor">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime/low не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime/high">
            <report test="@nullFlavor">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/effectiveTime/high не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/routeCode[not(@nullFlavor)]">
            <assert test="@codeSystem=['1.2.643.5.1.13.13.11.1468']">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/routeCode должен иметь значение атрибута @codeSystem равное '1.2.643.5.1.13.13.11.1468'.</assert>
            <assert test="@codeSystemName!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/routeCode должен иметь не пустое значение атрибута @codeSystemName.</assert>
            <assert test="@code!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/routeCode должен иметь не пустое значение атрибута @code.</assert>
            <assert test="@codeSystemVersion!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/routeCode должен иметь не пустое значение атрибута @codeSystemVersion.</assert>
            <assert test="@displayName!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/routeCode должен иметь не пустое значение атрибута @displayName.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/consumable/manufacturedProduct/manufacturedMaterial">
            <assert test="@determinerCode='KIND'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/consumable/manufacturedProduct/manufacturedMaterial должен иметь значение атрибута @determinerCode равное 'KIND'.</assert>
            <assert test="count(name)&lt;=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/consumable/manufacturedProduct/manufacturedMaterial должен иметь не более 1 элемента name.</assert>
            <report test="@nullFlavor">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/consumable/manufacturedProduct/manufacturedMaterial не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/consumable/manufacturedProduct/manufacturedMaterial/code[@nullFlavor]">
            <assert test="@nullFlavor='OTH'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/consumable/manufacturedProduct/manufacturedMaterial/code должен иметь значение атрибута @nullFlavor равное 'OTH'.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship[substanceAdministration]">
            <assert test="count(substanceAdministration)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship должен иметь 1 элемент substanceAdministration.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration">
            <assert test="count(effectiveTime)=2">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration должен иметь 2 элемента effectiveTime.</assert>
            <assert test="count(doseQuantity)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration должен иметь 1 элемент doseQuantity.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime[1][not(@nullFlavor)]">
            <assert test="@xsi:type='IVL_TS'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime должен иметь значение атрибута @xsi:type равное 'IVL_TS'.</assert>
            <assert test="count(width|low)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime должен иметь 1 элемент width или 1 элемент low.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime[1][low]">
            <assert test="count(high)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime[low] должен иметь 1 элемент high.</assert>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime[1]/low">
            <report test="@nullFlavor">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime/low не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime[1]/high">
            <report test="@nullFlavor">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime/high не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime[2][not(@nullFlavor)]">
            <assert test="@xsi:type='PIVL_TS'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime должен иметь значение атрибута @xsi:type равное 'PIVL_TS'.</assert>
            <assert test="@institutionSpecified=['true','false']">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime должен иметь значение атрибута @institutionSpecified равное 'true' или 'false'.</assert>
            <assert test="count(period)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime должен иметь 1 элемент period.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime[2]/period">
            <assert test="@value!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime/period должен иметь не пустое значение атрибута @value.</assert>
            <assert test="@unit!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime/period должен иметь не пустое значение атрибута @unit.</assert>
            <assert test="count(translation)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime/period должен иметь 1 элемент translation.</assert>
            <report test="@nullFlavor">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/substanceAdministration/effectiveTime/period не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']">
            ...
            <assert test="count(entryRelationship[observation/code/@code='6017'])&lt;=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011'] должен иметь не более 1 элемента entryRelationship.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation/code[@code='6011']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/value">
            <assert test="@xsi:type='PQ'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/value должен иметь значение атрибута @xsi:type равное 'PQ'.</assert>
            <assert test="@unit='U'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/value должен иметь значение атрибута @unit равное 'U'.</assert>
            <assert test="count(translation)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/value должен иметь 1 'элемент translation.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']">
            <assert test="count(value)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017'] должен иметь 1 элемент value.</assert>
            <assert test="count(entryRelationship)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017'] должен иметь 1 элемент entryRelationship.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation/code[@code='6017']">
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/value">
            <assert test="@xsi:type='CD'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/value должен иметь значение атрибута @xsi:type равное 'CD'.</assert>
            <assert test="@codeSystem=['1.2.643.5.1.13.13.99.2.687']">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/value должен иметь значение атрибута @xsi:type равное ['1.2.643.5.1.13.13.99.2.687'].</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship">
            <assert test="count(supply)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship должен иметь 1 элемент supply.</assert>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply">
            <assert test="count(effectiveTime)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply должен иметь 1 элемент effectiveTime.</assert>
            <assert test="count(quantity)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply должен иметь 1 элемент quantity.</assert>
            <assert test="@classCode='SPLY'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply должен иметь значение атрибута @classCode равное 'SPLY'.</assert>
            <assert test="@moodCode='RQO'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply должен иметь значение атрибута @moodCode равное 'RQO'.</assert>
            <report test="@nullFlavor">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/effectiveTime">
            <assert test="@xsi:type='PIVL_TS'">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/effectiveTime должен иметь значение атрибута @xsi:type равное 'PIVL_TS'.</assert>
            <assert test="@institutionSpecified=['true','false']">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/effectiveTime должен иметь значение атрибута @institutionSpecified равное 'true' или 'false'.</assert>
            <assert test="count(period)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/effectiveTime должен иметь 1 элемент period.</assert>
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/effectiveTime/period">
            <assert test="@value!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/effectiveTime/period должен иметь не пустое значение атрибута @value.</assert>
            <assert test="@unit!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/effectiveTime/period должен иметь не пустое значение атрибута @unit.</assert>
            <assert test="count(translation)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/effectiveTime/period должен иметь 1 элемент translation.</assert>
            <report test="@nullFlavor">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/effectiveTime/period не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/quantity">
            <assert test="@value!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/quantity должен иметь не пустое значение атрибута @value.</assert>
            <assert test="@unit!=''">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/quantity должен иметь не пустое значение атрибута @unit.</assert>
            <assert test="count(translation)=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/quantity должен иметь 1 элемент translation.</assert>
            <report test="@nullFlavor">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='RECIPE']/entry/substanceAdministration/entryRelationship/observation[code/@code='6011']/entryRelationship/observation[code/@code='6017']/entryRelationship/supply/quantity не должен иметь атрибут @nullFlavor.</report>
        </rule>
    </pattern>
    <!-- У3-5 -->
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LINKDOCS']">
            <assert test="count(entry[act])>=1">У3-5 Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LINKDOCS'] должен иметь не менее 1 элемента entry.</assert>
        </rule>
    </pattern>
...
<!-- Альтернативный вариант: допускается @nullFlavor для code в составе manufacturedMaterial -->
...
<!-- 20.10.2022 - v.1.0.0: Модуль разработан -->
    ...
    <!-- Core07-1 -->
    <pattern>
        <rule context="//code[not(ancestor::criterion)][not(ancestor::manufacturedMaterial)]">
            ...
            <report test="@nullFlavor">Core07-1. Элемент //code должен иметь не пустое значение атрибута @nullFlavor.</report>
        </rule>
    </pattern>
    <pattern>
    ...
    <pattern>
        <rule context="//code[ancestor::manufacturedMaterial][not(@nullFlavor)]">
            <assert test="@codeSystem!=''">Core07-1. Элемент //code должен иметь не пустое значение атрибута @codeSystem.</assert>
            <assert test="@codeSystemName!=''">Core07-1. Элемент //code должен иметь не пустое значение атрибута @codeSystemName.</assert>
            <assert test="@code!=''">Core07-1. Элемент //code должен иметь не пустое значение атрибута @code.</assert>
            <assert test="@codeSystemVersion!=''">Core07-1. //code должен иметь не пустое значение атрибута @codeSystemVersion.</assert>
...
<!-- [Core11_1]Модуль проверки наполнения секции (//observation/value[@xsi:type=['CD','ST','BL','PQ']], //translation, //text, //substanceAdministration, //precondition) -->
...
<!-- [Core12_2]Модуль проверки контактов (//telecom) -->

<!-- Альтернативный вариант: допускается @nullFlavor для telecom в составе providerOrganization -->
...
<!-- 20.10.2022 - v.1.0.0: Модуль разработан -->
    ...
    <pattern>
        <rule context="//telecom[(ancestor::scopingOrganization)|(ancestor::providerOrganization)][not(@nullFlavor)]">
            <assert test="@value!=''">Core12-1. Элемент //telecom должен иметь не пустое значение атрибута @value.</assert>
        </rule>
    </pattern>
