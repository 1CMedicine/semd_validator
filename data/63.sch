...
<!-- 08.04.2022 v.1.1 -->
<!--
1) В правиле У1-21 убрана фиксированность значения атрибута addr[2]/address:Type/@code равная '2'
2) В правиле У3-5 исправлен контекст для элемента reference
3) В правиле У1-27 текст описания исправлен с identity:Series на identity:Number
-->
<!-- 18.03.2022 v.1.0.2 -->
<!--
1) В правиле У1-27 убрана обязательность заполнения элемента identity:INN
2) В правиле У1-27 снижена кардинальность элемента participant до [0..1]
-->
<!-- 11.03.2022 v.1.0.1 -->
<!--
...
-->
    ...
    <pattern>
        ...
        <rule context="ClinicalDocument/templateId">
            <assert test="@root='1.2.643.5.1.13.13.14.45.9.1'">У1-11. Элемент ClinicalDocument/templateId должен иметь значение атрибута @root равное '1.2.643.5.1.13.13.14.45.9.1'.</assert>
        </rule>
    </pattern>
    <!-- У1-12 -->
    <pattern>
    ...
    <pattern>
        ...
        <rule context="ClinicalDocument/code">
            <assert test="@code='45'">У1-13. Элемент ClinicalDocument/code должен иметь значение атрибута @code равное '45'.</assert>
    ...
    <pattern>
        <rule context="ClinicalDocument/recordTarget/patientRole/addr[2][not(@nullFlavor)]">
            ...
            <assert test="address:Type/@code!=''">У1-21. Элемент ClinicalDocument/recordTarget/patientRole/addr[2]/address:Type должен иметь не пустое значение атрибута @code.</assert>
    ...
    <pattern>
        <rule context="ClinicalDocument">
            <assert test="count(participant)&lt;=1">У1-27. Элемент ClinicalDocument должен иметь не более 1 элемента participant.</assert>
        </rule>
...
-->
    ...
    <pattern>
        ...
        <rule context="ClinicalDocument/participant/associatedEntity[not(identity:DocInfo/identity:InsurancePolicyType/@nullFlavor='NAV')]">
            <assert test="identity:DocInfo/identity:Number!=''">У1-27. Элемент ClinicalDocument/participant/associatedEntity/identity:DocInfo/identity:Number должен иметь не пустое значение.</assert>
        </rule>
    </pattern>
<!--
    <pattern>
...
-->
    ...
    <pattern>
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO']">
            <assert test="count(entry[observation/code[@code='837']])&lt;=1">У3-4. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='DOCINFO'] должен иметь не более 1 элемента entry.</assert>
        </rule>
    ...
    <pattern>
        ...
        <rule context="ClinicalDocument/component/structuredBody/component/section[code/@code='LINKDOCS']/entry/act">
            ...
            <assert test="count(entryRelationship[observation/code[@code='11002']])&lt;=1">У3-5. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LINKDOCS']/entry/act должен иметь не более 1 элемента entryRelationship.</assert>
            <assert test="count(entryRelationship[observation/code[@code='11003']])&lt;=1">У3-5. Элемент ClinicalDocument/component/structuredBody/component/section[code/@code='LINKDOCS']/entry/act должен иметь не более 1 элемента entryRelationship.</assert>
