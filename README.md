...
-- LEVEL - уровень критичности сообщения при наличии проблемы INVALID_ELEMENT_VALUE_NAME в справочнике (несоответствие displayName значению поля VALUE справочника). Допустимые значения - ERROR, WARNING. Значение по умолчанию - ERROR.
